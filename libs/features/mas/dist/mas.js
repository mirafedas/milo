...
`,Oo=()=>[I`
        ...
        `}get cardImage(){return x` <div class="image">
            ...
            ${this.badge}
              ...
              >`:"";return x`<footer>${t}<slot name="footer"></slot></footer>`}async adjustTitleWidth(){let t=this.card.getBoundingClientRect().width,r=this.card.badgeElement?.getBoundingClientRect().width||0;t===0||r===0||this.card.style.setProperty("--consonant-merch-card-heading-xs-max-width",`${Math.round(t-r-16)}px`)}postCardUpdateHook(){}connectedCallbackHook(){}disconnectedCallbackHook(){}renderLayout(){}get aemFragmentMapping(){}};rt=new WeakMap,p(Ot,"styleMap",{});var k=Ot;function te(e,t={},r=""){let n=document.createElement(e);r instanceof HTMLElement?n.appendChild(r):n.innerHTML=r;for(let[i,o]of Object.entries(t))n.setAttribute(i,o);return n}function mr(){return window.matchMedia("(max-width: 767px)").matches}function Ro(){return window.matchMedia("(max-width: 1024px)").matches}var Hn={};Cs(Hn,{CLASS_NAME_FAILED:()=>Cn,CLASS_NAME_HIDDEN:()=>Fs,CLASS_NAME_PENDING:()=>In,CLASS_NAME_RESOLVED:()=>kn,ERROR_MESSAGE_BAD_REQUEST:()=>gr,ERROR_MESSAGE_MISSING_LITERALS_URL:()=>Js,ERROR_MESSAGE_OFFER_NOT_FOUND:()=>Nn,EVENT_AEM_ERROR:()=>$e,EVENT_AEM_LOAD:()=>Ve,EVENT_MAS_ERROR:()=>Pn,EVENT_MAS_READY:()=>wn,EVENT_MERCH_CARD_ACTION_MENU_TOGGLE:()=>_n,EVENT_MERCH_CARD_COLLECTION_SHOWMORE:()=>qs,EVENT_MERCH_CARD_COLLECTION_SORT:()=>Ws,EVENT_MERCH_CARD_READY:()=>Ln,EVENT_MERCH_OFFER_READY:()=>js,EVENT_MERCH_OFFER_SELECT_READY:()=>Tn,EVENT_MERCH_QUANTITY_SELECTOR_CHANGE:()=>fr,EVENT_MERCH_SEARCH_CHANGE:()=>Xs,EVENT_MERCH_SIDENAV_SELECT:()=>Zs,EVENT_MERCH_STOCK_CHANGE:()=>Ys,EVENT_MERCH_STORAGE_CHANGE:()=>pr,EVENT_OFFER_SELECTED:()=>Ks,EVENT_TYPE_FAILED:()=>On,EVENT_TYPE_PENDING:()=>Rn,EVENT_TYPE_READY:()=>nt,EVENT_TYPE_RESOLVED:()=>Vn,LOG_NAMESPACE:()=>$n,Landscape:()=>Me,NAMESPACE:()=>zs,PARAM_AOS_API_KEY:()=>Qs,PARAM_ENV:()=>Mn,PARAM_LANDSCAPE:()=>Un,PARAM_WCS_API_KEY:()=>ec,STATE_FAILED:()=>he,STATE_PENDING:()=>de,STATE_RESOLVED:()=>ue,TAG_NAME_SERVICE:()=>Bs,WCS_PROD_URL:()=>Dn,WCS_STAGE_URL:()=>Gn});var zs="merch",Fs="hidden",nt="wcms:commerce:ready",Bs="mas-commerce-service",js="merch-offer:ready",Tn="merch-offer-select:ready",Ln="merch-card:ready",_n="merch-card:action-menu-toggle",Ks="merch-offer:selected",Ys="merch-stock:change",pr="merch-storage:change",fr="merch-quantity-selector:change",Xs="merch-search:change",Ws="merch-card-collection:sort",qs="merch-card-collection:showmore",Zs="merch-sidenav:select",Ve="aem:load",$e="aem:error",wn="mas:ready",Pn="mas:error",Cn="placeholder-failed",In="placeholder-pending",kn="placeholder-resolved",gr="Bad WCS request",Nn="Commerce offer not found",Js="Literals URL not provided",On="mas:failed",Rn="mas:pending",Vn="mas:resolved",$n="mas/commerce",Mn="commerce.env",Un="commerce.landscape",Qs="commerce.aosKey",ec="commerce.wcsKey",Dn="https://www.adobe.com/web_commerce_artifact",Gn="https://www.stage.adobe.com/web_commerce_artifact_stage",he="failed",de="pending",ue="resolved",Me={DRAFT:"DRAFT",PUBLISHED:"PUBLISHED"};var Vo=`
:root {
...
`;var xr=class extends k{constructor(t){super(t)}getGlobalCSS(){return $o}renderLayout(){return x`${this.cardImage}
    <div class="body">
...
`;var vr=class extends k{constructor(t){super(t)}getGlobalCSS(){return Mo}renderLayout(){return x` ${this.badge}
    <div class="body">
        <div class="top-section">
            <slot name="icons"></slot>
            <slot name="heading-xs"></slot>
...
`;var rc=32,ot=class extends k{constructor(r){super(r);p(this,"getRowMinHeightPropertyName",r=>`--consonant-merch-card-footer-row-${r}-min-height`);p(this,"getMiniCompareFooter",()=>{let r=this.card.secureLabel?x`<slot name="secure-transaction-label">
...
`;var at=class extends k{constructor(t){super(t)}getGlobalCSS(){return Do}postCardUpdateHook(){this.adjustTitleWidth()}get stockCheckbox(){return this.card.checkboxLabel?x`<label id="stock-checkbox">
...
`;var st=class extends k{constructor(t){super(t)}getGlobalCSS(){return Ho}postCardUpdateHook(){this.adjustTitleWidth()}renderLayout(){return x` ${this.badge}
    <div class="body">
        <slot name="heading-xs"></slot>
        <slot name="body-xxs"></slot>
        ${this.promoBottom?"":x`<slot name="promo-text"></slot><slot name="callout-content"></slot>`}
...
`;var nc={name:{tag:"h4",slot:"detail-m"},title:{tag:"h4",slot:"detail-m"},backgroundImage:{tag:"div",slot:"bg-image"},prices:{tag:"h3",slot:"heading-xs"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"footer",size:"l"}},ct=class extends k{constructor(t){super(t)}getGlobalCSS(){return zo}get headingSelector(){return'[slot="detail-m"]'}get aemFragmentMapping(){return nc}renderLayout(){return x`${this.cardImage}
            <div class="body">
...
`;var lt=class extends k{constructor(t){super(t)}getGlobalCSS(){return Fo}renderLayout(){return x`${this.badge}
      <div class="top-section">
          <slot name="icons"></slot>
          <slot name="heading-xs"></slot>
...
`;var ic={mnemonics:{size:"l"},subtitle:{tag:"h4",slot:"detail-s"},title:{tag:"h3",slot:"heading-xs"},prices:{tag:"p",slot:"price"},description:{tag:"div",slot:"body-xs"},ctas:{slot:"cta",size:"M"}},ht=class extends k{getGlobalCSS(){return Bo}get aemFragmentMapping(){return ic}get stripStyle(){return this.card.backgroundImage?`
...
`;var oc={mnemonics:{size:"m"},backgroundImage:{tag:"div",slot:"image"},description:{tag:"div",slot:"body-s"},ctas:{slot:"footer",size:"S"},allowedSizes:["wide"]},dt=class extends k{getGlobalCSS(){return jo}get aemFragmentMapping(){return oc}renderLayout(){return x` <div class="content">
                <div class="top-section">
                  <slot name="icons"></slot> 
                  ${this.badge}
                </div>  
...
`;document.head.appendChild(Yo);var ac="#000000",sc="#F8D904",cc=/(accent|primary|secondary)(-(outline|link))?/,lc="mas:product_code/",hc="daa-ll",br="daa-lh",dc=["XL","L","M","S"];function uc(e,t,r){e.mnemonicIcon?.map((i,o)=>({icon:i,alt:e.mnemonicAlt[o]??"",link:e.mnemonicLink[o]??""}))?.forEach(({icon:i,alt:o,link:a})=>{if(a&&!/^https?:/.test(a))try{a=new URL(`https://${a}`).href.toString()}catch{a="#"}let s={slot:"icons",src:i,size:r?.size??"l"};o&&(s.alt=o),a&&(s.href=a);let c=te("merch-icon",s);t.append(c)})}function mc(e,t){e.badge&&(t.setAttribute("badge-text",e.badge),t.setAttribute("badge-color",e.badgeColor||ac),t.setAttribute("badge-background-color",e.badgeBackgroundColor||sc))}function pc(e,t,r){r?.includes(e.size)&&t.setAttribute("size",e.size)}function fc(e,t,r){e.cardTitle&&r&&t.append(te(r.tag,{slot:r.slot},e.cardTitle))}function gc(e,t,r){e.subtitle&&r&&t.append(te(r.tag,{slot:r.slot},e.subtitle))}function xc(e,t,r,n){if(e.backgroundImage)switch(n){case"ccd-slice":r&&t.append(te(r.tag,{slot:r.slot},`<img loading="lazy" src="${e.backgroundImage}" />`));break;case"ccd-suggested":t.setAttribute("background-image",e.backgroundImage);break}}function vc(e,t,r){if(e.prices&&r){let n=te(r.tag,{slot:r.slot},e.prices);t.append(n)}}function bc(e,t,r){if(e.description&&r){let n=te(r.tag,{slot:r.slot},e.description);t.append(n)}}function Ac(e,t,r,n){let i=t.ctas.size??"M",o=`spectrum-Button--${n}`,a=r?" spectrum-Button--outline":"";e.classList.add("spectrum-Button-label");let s=dc.includes(i)?` spectrum-Button--size${i}`:" spectrum-Button--sizeM",c=`spectrum-Button ${o}${a}${s}`,h=te("button",{class:c,tabIndex:0},e);return h.addEventListener("click",l=>{l.target!==e&&(l.stopPropagation(),e.click())}),h}function Ec(e,t,r,n){let i="fill";r&&(i="outline");let o=te("sp-button",{treatment:i,variant:n,tabIndex:0,size:t.ctas.size??"m"},e);return o.addEventListener("click",a=>{a.target!==e&&(a.stopPropagation(),e.click())}),o}function Sc(e,t){return e.classList.add("con-button"),t&&e.classList.add("blue"),e}function yc(e,t,r,n){if(e.ctas){let{slot:i}=r.ctas,o=te("div",{slot:i},e.ctas),a=[...o.querySelectorAll("a")].map(s=>{let c=s.parentElement.tagName==="STRONG";if(t.consonant)return Sc(s,c);let h=cc.exec(s.className)?.[0]??"accent",l=h.includes("accent"),d=h.includes("primary"),u=h.includes("secondary"),m=h.includes("-outline");if(h.includes("-link"))return s;let f;return l||c?f="accent":d?f="primary":u&&(f="secondary"),s.tabIndex=-1,t.spectrum==="swc"?Ec(s,r,m,f):Ac(s,r,m,f)});o.innerHTML="",o.append(...a),t.append(o)}}function Tc(e,t){let{tags:r}=e,n=r?.find(i=>i.startsWith(lc))?.split("/").pop();n&&(t.setAttribute(br,n),t.querySelectorAll("a[data-analytics-id]").forEach((i,o)=>{i.setAttribute(hc,`${i.dataset.analyticsId}-${o+1}`)}))}function Lc(e){[["primary-link","primary"],["secondary-link","secondary"]].forEach(([t,r])=>{e.querySelectorAll(`a.${t}`).forEach(n=>{n.classList.remove(t),n.classList.add("spectrum-Link",`spectrum-Link--${r}`)})})}async function Xo(e,t){let{fields:r}=e,{variant:n}=r;if(!n)return;t.querySelectorAll("[slot]").forEach(o=>{o.remove()}),t.removeAttribute("background-image"),t.removeAttribute("badge-background-color"),t.removeAttribute("badge-color"),t.removeAttribute("badge-text"),t.removeAttribute("size"),t.classList.remove("wide-strip"),t.classList.remove("thin-strip"),t.removeAttribute(br),t.variant=n,await t.updateComplete;let{aemFragmentMapping:i}=t.variantLayout;i&&(uc(r,t,i.mnemonics),mc(r,t),pc(r,t,i.allowedSizes),fc(r,t,i.title),gc(r,t,i.subtitle),vc(r,t,i.prices),xc(r,t,i.backgroundImage,n),bc(r,t,i.description),yc(r,t,i,n),Tc(r,t),Lc(t))}var _c="merch-card",wc=1e4,Bn,Vt,Fn,Rt=class extends ee{constructor(){super();M(this,Vt);p(this,"customerSegment");p(this,"marketSegment");p(this,"variantLayout");M(this,Bn,!1);this.filters={},this.types="",this.selected=!1,this.spectrum="css",this.handleAemFragmentEvents=this.handleAemFragmentEvents.bind(this)}firstUpdated(){this.variantLayout=zn(this,!1),this.variantLayout?.connectedCallbackHook(),this.aemFragment?.updateComplete.catch(()=>{this.style.display="none"})}willUpdate(r){(r.has("variant")||!this.variantLayout)&&(this.variantLayout=zn(this),this.variantLayout.connectedCallbackHook())}updated(r){(r.has("badgeBackgroundColor")||r.has("borderColor"))&&this.style.setProperty("--consonant-merch-card-border",this.computedBorderStyle),this.variantLayout?.postCardUpdateHook(r)}get theme(){return this.closest("sp-theme")}get dir(){return this.closest("[dir]")?.getAttribute("dir")??"ltr"}get prices(){return Array.from(this.querySelectorAll('span[is="inline-price"][data-wcs-osi]'))}render(){if(!(!this.isConnected||!this.variantLayout||this.style.display==="none"))return this.variantLayout.renderLayout()}get computedBorderStyle(){return["twp","ccd-slice","ccd-suggested"].includes(this.variant)?"":`1px solid ${this.borderColor?this.borderColor:this.badgeBackgroundColor}`}get badgeElement(){return this.shadowRoot.getElementById("badge")}get headingmMSlot(){return this.shadowRoot.querySelector('slot[name="heading-m"]').assignedElements()[0]}get footerSlot(){return this.shadowRoot.querySelector('slot[name="footer"]')?.assignedElements()[0]}get price(){return this.headingmMSlot?.querySelector('span[is="inline-price"]')}get checkoutLinks(){return[...this.footerSlot?.querySelectorAll('a[is="checkout-link"]')??[]]}async toggleStockOffer({target:r}){if(!this.stockOfferOsis)return;let n=this.checkoutLinks;if(n.length!==0)for(let i of n){await i.onceSettled();let o=i.value?.[0]?.planType;if(!o)return;let a=this.stockOfferOsis[o];if(!a)return;let s=i.dataset.wcsOsi.split(",").filter(c=>c!==a);r.checked&&s.push(a),i.dataset.wcsOsi=s.join(",")}}handleQuantitySelection(r){let n=this.checkoutLinks;for(let i of n)i.dataset.quantity=r.detail.option}get titleElement(){return this.querySelector(this.variantLayout?.headingSelector||".card-heading")}get title(){return this.titleElement?.textContent?.trim()}get description(){return this.querySelector('[slot="body-xs"]')?.textContent?.trim()}updateFilters(r){let n={...this.filters};Object.keys(n).forEach(i=>{if(r){n[i].order=Math.min(n[i].order||2,2);return}let o=n[i].order;o===1||isNaN(o)||(n[i].order=Number(o)+1)}),this.filters=n}includes(r){return this.textContent.match(new RegExp(r,"i"))!==null}connectedCallback(){super.connectedCallback(),this.addEventListener(fr,this.handleQuantitySelection),this.addEventListener(Tn,this.merchCardReady,{once:!0}),this.updateComplete.then(()=>{this.merchCardReady()}),this.storageOptions?.addEventListener("change",this.handleStorageChange),this.addEventListener($e,this.handleAemFragmentEvents),this.addEventListener(Ve,this.handleAemFragmentEvents),this.aemFragment||setTimeout(()=>this.checkReady(),0)}disconnectedCallback(){super.disconnectedCallback(),this.variantLayout?.disconnectedCallbackHook(),this.removeEventListener(fr,this.handleQuantitySelection),this.storageOptions?.removeEventListener(pr,this.handleStorageChange),this.removeEventListener($e,this.handleAemFragmentEvents),this.removeEventListener(Ve,this.handleAemFragmentEvents)}async handleAemFragmentEvents(r){if(r.type===$e&&ge(this,Vt,Fn).call(this,"AEM fragment cannot be loaded"),r.type===Ve&&r.target.nodeName==="AEM-FRAGMENT"){let n=r.detail;await Xo(n,this),this.checkReady()}}async checkReady(){let r=Promise.all([...this.querySelectorAll('span[is="inline-price"][data-wcs-osi],a[is="checkout-link"][data-wcs-osi]')].map(o=>o.onceSettled().catch(()=>o))).then(o=>o.every(a=>a.classList.contains("placeholder-resolved"))),n=new Promise(o=>setTimeout(()=>o(!1),wc));if(await Promise.race([r,n])===!0){this.dispatchEvent(new CustomEvent(wn,{bubbles:!0,composed:!0}));return}ge(this,Vt,Fn).call(this,"Contains unresolved offers")}get aemFragment(){return this.querySelector("aem-fragment")}get storageOptions(){return this.querySelector("sp-radio-group#storage")}get storageSpecificOfferSelect(){let r=this.storageOptions?.selected;if(r){let n=this.querySelector(`merch-offer-select[storage="${r}"]`);if(n)return n}return this.querySelector("merch-offer-select")}get offerSelect(){return this.storageOptions?this.storageSpecificOfferSelect:this.querySelector("merch-offer-select")}get quantitySelect(){return this.querySelector("merch-quantity-select")}merchCardReady(){this.offerSelect&&!this.offerSelect.planType||this.dispatchEvent(new CustomEvent(Ln,{bubbles:!0}))}handleStorageChange(){let r=this.closest("merch-card")?.offerSelect.cloneNode(!0);r&&this.dispatchEvent(new CustomEvent(pr,{detail:{offerSelect:r},bubbles:!0}))}get dynamicPrice(){return this.querySelector('[slot="price"]')}selectMerchOffer(r){if(r===this.merchOffer)return;this.merchOffer=r;let n=this.dynamicPrice;if(r.price&&n){let i=r.price.cloneNode(!0);n.onceSettled?n.onceSettled().then(()=>{n.replaceWith(i)}):n.replaceWith(i)}}};Bn=new WeakMap,Vt=new WeakSet,Fn=function(r){this.dispatchEvent(new CustomEvent(Pn,{detail:r,bubbles:!0,composed:!0}))},p(Rt,"properties",{name:{type:String,attribute:"name",reflect:!0},variant:{type:String,reflect:!0},size:{type:String,attribute:"size",reflect:!0},badgeColor:{type:String,attribute:"badge-color",reflect:!0},borderColor:{type:String,attribute:"border-color",reflect:!0},badgeBackgroundColor:{type:String,attribute:"badge-background-color",reflect:!0},backgroundImage:{type:String,attribute:"background-image",reflect:!0},badgeText:{type:String,attribute:"badge-text"},actionMenu:{type:Boolean,attribute:"action-menu"},customHr:{type:Boolean,attribute:"custom-hr"},consonant:{type:Boolean,attribute:"consonant"},spectrum:{type:String,attribute:"spectrum"},detailBg:{type:String,attribute:"detail-bg"},secureLabel:{type:String,attribute:"secure-label"},checkboxLabel:{type:String,attribute:"checkbox-label"},selected:{type:Boolean,attribute:"aria-selected",reflect:!0},storageOption:{type:String,attribute:"storage",reflect:!0},stockOfferOsis:{type:Object,attribute:"stock-offer-osis",converter:{fromAttribute:r=>{let[n,i,o]=r.split(",");return{PUF:n,ABM:i,M2M:o}}}},filters:{type:String,reflect:!0,converter:{fromAttribute:r=>Object.fromEntries(r.split(",").map(n=>{let[i,o,a]=n.split(":"),s=Number(o);return[i,{order:isNaN(s)?void 0:s,size:a}]})),toAttribute:r=>Object.entries(r).map(([n,{order:i,size:o}])=>[n,i,o].filter(a=>a!=null).join(":")).join(",")}},types:{type:String,attribute:"types",reflect:!0},merchOffer:{type:Object},analyticsId:{type:String,attribute:br,reflect:!0}}),p(Rt,"styles",[No,Ko(),...Oo()]);customElements.define(_c,Rt);var ut=class extends ee{constructor(){super(),this.size="m",this.alt=""}render(){let{href:t}=this;return t?x`<a href="${t}">
    ...
    `);customElements.define("merch-icon",ut);var Jo=new CSSStyleSheet;Jo.replaceSync(":host { display: contents; }");var Pc=document.querySelector('meta[name="aem-base-url"]')?.content??"https://odin.adobe.com",Wo="fragment",qo="author",Cc="ims",Zo=e=>{throw new Error(`Failed to get fragment: ${e}`)};async function Ic(e,t,r,n){let i=r?`${e}/adobe/sites/cf/fragments/${t}`:`${e}/adobe/sites/fragments/${t}`,o=await fetch(i,{cache:"default",credentials:"omit",headers:n}).catch(a=>Zo(a.message));return o?.ok||Zo(`${o.status} ${o.statusText}`),o.json()}var jn,Ee,Kn=class{constructor(){M(this,Ee,new Map)}clear(){L(this,Ee).clear()}add(...t){t.forEach(r=>{let{id:n}=r;n&&L(this,Ee).set(n,r)})}has(t){return L(this,Ee).has(t)}get(t){return L(this,Ee).get(t)}remove(t){L(this,Ee).delete(t)}};Ee=new WeakMap;var Ar=new Kn,De,me,Se,$t,pe,mt,Mt,Xn,Er,Qo,Sr,ea,Yn=class extends HTMLElement{constructor(){super();M(this,Mt);M(this,Er);M(this,Sr);p(this,"cache",Ar);M(this,De,void 0);M(this,me,void 0);M(this,Se,void 0);M(this,$t,!1);M(this,pe,void 0);M(this,mt,!1);this.attachShadow({mode:"open"}),this.shadowRoot.adoptedStyleSheets=[Jo];let r=this.getAttribute(Cc);["",!0,"true"].includes(r)&&(B(this,$t,!0),jn||(jn={Authorization:`Bearer ${window.adobeid?.authorize?.()}`}))}static get observedAttributes(){return[Wo,qo]}attributeChangedCallback(r,n,i){r===Wo&&(B(this,Se,i),this.refresh(!1)),r===qo&&B(this,mt,["","true"].includes(i))}connectedCallback(){if(!L(this,Se)){ge(this,Mt,Xn).call(this,"Missing fragment id");return}}async refresh(r=!0){L(this,pe)&&!await Promise.race([L(this,pe),Promise.resolve(!1)])||(r&&Ar.remove(L(this,Se)),B(this,pe,this.fetchData().then(()=>(this.dispatchEvent(new CustomEvent(Ve,{detail:this.data,bubbles:!0,composed:!0})),!0)).catch(n=>(ge(this,Mt,Xn).call(this,"Network error: failed to load fragment"),B(this,pe,null),!1))),L(this,pe))}async fetchData(){B(this,De,null),B(this,me,null);let r=Ar.get(L(this,Se));r||(r=await Ic(Pc,L(this,Se),L(this,mt),L(this,$t)?jn:void 0),Ar.add(r)),B(this,De,r)}get updateComplete(){return L(this,pe)??Promise.reject(new Error("AEM fragment cannot be loaded"))}get data(){return L(this,me)?L(this,me):(L(this,mt)?ge(this,Er,Qo).call(this):ge(this,Sr,ea).call(this),L(this,me))}};De=new WeakMap,me=new WeakMap,Se=new WeakMap,$t=new WeakMap,pe=new WeakMap,mt=new WeakMap,Mt=new WeakSet,Xn=function(r){this.classList.add("error"),this.dispatchEvent(new CustomEvent($e,{detail:r,bubbles:!0,composed:!0}))},Er=new WeakSet,Qo=function(){let{id:r,tags:n,fields:i}=L(this,De);B(this,me,i.reduce((o,{name:a,multiple:s,values:c})=>(o.fields[a]=s?c:c[0],o),{id:r,tags:n,fields:{}}))},Sr=new WeakSet,ea=function(){let{id:r,tags:n,fields:i}=L(this,De);B(this,me,Object.entries(i).reduce((o,[a,s])=>(o.fields[a]=s?.mimeType?s.value:s??"",o),{id:r,tags:n,fields:{}}))};customElements.define("aem-fragment",Yn);var Ge={clientId:"merch-at-scale",delimiter:"\xB6",ignoredProperties:["analytics","literals"],serializableTypes:["Array","Object"],sampleRate:1,tags:"acom",isProdDomain:!1},ta=1e3,ra=new Set;function kc(e){return e instanceof Error||typeof e?.originatingRequest=="string"}function na(e){if(e==null)return;let t=typeof e;if(t==="function")return e.name?`function ${e.name}`:"function";if(t==="object"){if(e instanceof Error)return e.message;if(typeof e.originatingRequest=="string"){let{message:n,originatingRequest:i,status:o}=e;return[n,o,i].filter(Boolean).join(" ")}let r=e[Symbol.toStringTag]??Object.getPrototypeOf(e).constructor.name;if(!Ge.serializableTypes.includes(r))return r}return e}function Nc(e,t){if(!Ge.ignoredProperties.includes(e))return na(t)}var Wn={append(e){if(e.level!=="error")return;let{message:t,params:r}=e,n=[],i=[],o=t;r.forEach(h=>{h!=null&&(kc(h)?n:i).push(h)}),n.length&&(o+=" "+n.map(na).join(" "));let{pathname:a,search:s}=window.location,c=`${Ge.delimiter}page=${a}${s}`;c.length>ta&&(c=`${c.slice(0,ta)}<trunc>`),o+=c,i.length&&(o+=`${Ge.delimiter}facts=`,o+=JSON.stringify(i,Nc)),ra.has(o)||(ra.add(o),window.lana?.log(o,Ge))}};function pt(e){Object.assign(Ge,Object.fromEntries(Object.entries(e).filter(([t,r])=>t in Ge&&r!==""&&r!==null&&r!==void 0&&!Number.isNaN(r))))}var Ut;(function(e){e.STAGE="STAGE",e.PRODUCTION="PRODUCTION",e.LOCAL="LOCAL"})(Ut||(Ut={}));var qn;(function(e){e.STAGE="STAGE",e.PRODUCTION="PROD",e.LOCAL="LOCAL"})(qn||(qn={}));var Dt;(function(e){e.DRAFT="DRAFT",e.PUBLISHED="PUBLISHED"})(Dt||(Dt={}));var He;(function(e){e.V2="UCv2",e.V3="UCv3"})(He||(He={}));var Z;(function(e){e.CHECKOUT="checkout",e.CHECKOUT_EMAIL="checkout/email",e.SEGMENTATION="segmentation",e.BUNDLE="bundle",e.COMMITMENT="commitment",e.RECOMMENDATION="recommendation",e.EMAIL="email",e.PAYMENT="payment",e.CHANGE_PLAN_TEAM_PLANS="change-plan/team-upgrade/plans",e.CHANGE_PLAN_TEAM_PAYMENT="change-plan/team-upgrade/payment"})(Z||(Z={}));var Zn=function(e){var t;return(t=Oc.get(e))!==null&&t!==void 0?t:e},Oc=new Map([["countrySpecific","cs"],["quantity","q"],["authCode","code"],["checkoutPromoCode","apc"],["rurl","rUrl"],["curl","cUrl"],["ctxrturl","ctxRtUrl"],["country","co"],["language","lang"],["clientId","cli"],["context","ctx"],["productArrangementCode","pa"],["offerType","ot"],["marketSegment","ms"]]);var ia=function(e){var t=typeof Symbol=="function"&&Symbol.iterator,r=t&&e[t],n=0;if(r)return r.call(e);if(e&&typeof e.length=="number")return{next:function(){return e&&n>=e.length&&(e=void 0),{value:e&&e[n++],done:!e}}};throw new TypeError(t?"Object is not iterable.":"Symbol.iterator is not defined.")},oa=function(e,t){var r=typeof Symbol=="function"&&e[Symbol.iterator];if(!r)return e;var n=r.call(e),i,o=[],a;try{for(;(t===void 0||t-- >0)&&!(i=n.next()).done;)o.push(i.value)}catch(s){a={error:s}}finally{try{i&&!i.done&&(r=n.return)&&r.call(n)}finally{if(a)throw a.error}}return o};function ft(e,t,r){var n,i;try{for(var o=ia(Object.entries(e)),a=o.next();!a.done;a=o.next()){var s=oa(a.value,2),c=s[0],h=s[1],l=Zn(c);h!=null&&r.has(l)&&t.set(l,h)}}catch(d){n={error:d}}finally{try{a&&!a.done&&(i=o.return)&&i.call(o)}finally{if(n)throw n.error}}}function yr(e){switch(e){case Ut.PRODUCTION:return"https://commerce.adobe.com";default:return"https://commerce-stg.adobe.com"}}function Tr(e,t){var r,n;for(var i in e){var o=e[i];try{for(var a=(r=void 0,ia(Object.entries(o))),s=a.next();!s.done;s=a.next()){var c=oa(s.value,2),h=c[0],l=c[1];if(l!=null){var d=Zn(h);t.set("items["+i+"]["+d+"]",l)}}}catch(u){r={error:u}}finally{try{s&&!s.done&&(n=a.return)&&n.call(a)}finally{if(r)throw r.error}}}}var Rc=function(e,t){var r={};for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&t.indexOf(n)<0&&(r[n]=e[n]);if(e!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,n=Object.getOwnPropertySymbols(e);i<n.length;i++)t.indexOf(n[i])<0&&Object.prototype.propertyIsEnumerable.call(e,n[i])&&(r[n[i]]=e[n[i]]);return r},Vc=function(e){var t=typeof Symbol=="function"&&Symbol.iterator,r=t&&e[t],n=0;if(r)return r.call(e);if(e&&typeof e.length=="number")return{next:function(){return e&&n>=e.length&&(e=void 0),{value:e&&e[n++],done:!e}}};throw new TypeError(t?"Object is not iterable.":"Symbol.iterator is not defined.")};function aa(e){Uc(e);var t=e.env,r=e.items,n=e.workflowStep,i=Rc(e,["env","items","workflowStep"]),o=new URL(yr(t));return o.pathname=n+"/",Tr(r,o.searchParams),ft(i,o.searchParams,$c),o.toString()}var $c=new Set(["cli","co","lang","ctx","cUrl","mv","nglwfdata","otac","promoid","rUrl","sdid","spint","trackingid","code","campaignid","appctxid"]),Mc=["env","workflowStep","clientId","country","items"];function Uc(e){var t,r;try{for(var n=Vc(Mc),i=n.next();!i.done;i=n.next()){var o=i.value;if(!e[o])throw new Error('Argument "checkoutData" is not valid, missing: '+o)}}catch(a){t={error:a}}finally{try{i&&!i.done&&(r=n.return)&&r.call(n)}finally{if(t)throw t.error}}return!0}var Dc=function(e,t){var r={};for(var n in e)Object.prototype.hasOwnProperty.call(e,n)&&t.indexOf(n)<0&&(r[n]=e[n]);if(e!=null&&typeof Object.getOwnPropertySymbols=="function")for(var i=0,n=Object.getOwnPropertySymbols(e);i<n.length;i++)t.indexOf(n[i])<0&&Object.prototype.propertyIsEnumerable.call(e,n[i])&&(r[n[i]]=e[n[i]]);return r},Gc=function(e){var t=typeof Symbol=="function"&&Symbol.iterator,r=t&&e[t],n=0;if(r)return r.call(e);if(e&&typeof e.length=="number")return{next:function(){return e&&n>=e.length&&(e=void 0),{value:e&&e[n++],done:!e}}};throw new TypeError(t?"Object is not iterable.":"Symbol.iterator is not defined.")},Hc="p_draft_landscape",zc="/store/";function Qn(e){Bc(e);var t=e.env,r=e.items,n=e.workflowStep,i=e.ms,o=e.marketSegment,a=e.ot,s=e.offerType,c=e.pa,h=e.productArrangementCode,l=e.landscape,d=Dc(e,["env","items","workflowStep","ms","marketSegment","ot","offerType","pa","productArrangementCode","landscape"]),u={marketSegment:o??i,offerType:s??a,productArrangementCode:h??c},m=new URL(yr(t));return m.pathname=""+zc+n,n!==Z.SEGMENTATION&&n!==Z.CHANGE_PLAN_TEAM_PLANS&&Tr(r,m.searchParams),n===Z.SEGMENTATION&&ft(u,m.searchParams,Jn),ft(d,m.searchParams,Jn),l===Dt.DRAFT&&ft({af:Hc},m.searchParams,Jn),m.toString()}var Jn=new Set(["af","ai","apc","appctxid","cli","co","csm","ctx","ctxRtUrl","DCWATC","dp","fr","gsp","ijt","lang","lo","mal","ms","mv","mv2","nglwfdata","ot","otac","pa","pcid","promoid","q","rf","sc","scl","sdid","sid","spint","svar","th","thm","trackingid","usid","workflowid","context.guid","so.ca","so.su","so.tr","so.va"]),Fc=["env","workflowStep","clientId","country"];function Bc(e){var t,r;try{for(var n=Gc(Fc),i=n.next();!i.done;i=n.next()){var o=i.value;if(!e[o])throw new Error('Argument "checkoutData" is not valid, missing: '+o)}}catch(a){t={error:a}}finally{try{i&&!i.done&&(r=n.return)&&r.call(n)}finally{if(t)throw t.error}}if(e.workflowStep!==Z.SEGMENTATION&&e.workflowStep!==Z.CHANGE_PLAN_TEAM_PLANS&&!e.items)throw new Error('Argument "checkoutData" is not valid, missing: items');return!0}function ei(e,t){switch(e){case He.V2:return aa(t);case He.V3:return Qn(t);default:return console.warn("Unsupported CheckoutType, will use UCv3 as default. Given type: "+e),Qn(t)}}var ti;(function(e){e.BASE="BASE",e.TRIAL="TRIAL",e.PROMOTION="PROMOTION"})(ti||(ti={}));var D;(function(e){e.MONTH="MONTH",e.YEAR="YEAR",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.PERPETUAL="PERPETUAL",e.TERM_LICENSE="TERM_LICENSE",e.ACCESS_PASS="ACCESS_PASS",e.THREE_MONTHS="THREE_MONTHS",e.SIX_MONTHS="SIX_MONTHS"})(D||(D={}));var N;(function(e){e.ANNUAL="ANNUAL",e.MONTHLY="MONTHLY",e.TWO_YEARS="TWO_YEARS",e.THREE_YEARS="THREE_YEARS",e.P1D="P1D",e.P1Y="P1Y",e.P3Y="P3Y",e.P10Y="P10Y",e.P15Y="P15Y",e.P3D="P3D",e.P7D="P7D",e.P30D="P30D",e.HALF_YEARLY="HALF_YEARLY",e.QUARTERLY="QUARTERLY"})(N||(N={}));var ri;(function(e){e.INDIVIDUAL="INDIVIDUAL",e.TEAM="TEAM",e.ENTERPRISE="ENTERPRISE"})(ri||(ri={}));var ni;(function(e){e.COM="COM",e.EDU="EDU",e.GOV="GOV"})(ni||(ni={}));var ii;(function(e){e.DIRECT="DIRECT",e.INDIRECT="INDIRECT"})(ii||(ii={}));var oi;(function(e){e.ENTERPRISE_PRODUCT="ENTERPRISE_PRODUCT",e.ETLA="ETLA",e.RETAIL="RETAIL",e.VIP="VIP",e.VIPMP="VIPMP",e.FREE="FREE"})(oi||(oi={}));var sa="tacocat.js";var Lr=(e,t)=>String(e??"").toLowerCase()==String(t??"").toLowerCase(),ca=e=>`${e??""}`.replace(/[&<>'"]/g,t=>({"&":"&amp;","<":"&lt;",">":"&gt;","'":"&#39;",'"':"&quot;"})[t]??t)??"";function O(e,t={},{metadata:r=!0,search:n=!0,storage:i=!0}={}){let o;if(n&&o==null){let a=new URLSearchParams(window.location.search),s=gt(n)?n:e;o=a.get(s)}if(i&&o==null){let a=gt(i)?i:e;o=window.sessionStorage.getItem(a)??window.localStorage.getItem(a)}if(r&&o==null){let a=jc(gt(r)?r:e);o=document.documentElement.querySelector(`meta[name="${a}"]`)?.content}return o??t[e]}var xt=()=>{};var la=e=>typeof e=="boolean",Gt=e=>typeof e=="function",_r=e=>typeof e=="number",ha=e=>e!=null&&typeof e=="object";var gt=e=>typeof e=="string",ai=e=>gt(e)&&e,vt=e=>_r(e)&&Number.isFinite(e)&&e>0;function bt(e,t=r=>r==null||r===""){return e!=null&&Object.entries(e).forEach(([r,n])=>{t(n)&&delete e[r]}),e}function y(e,t){if(la(e))return e;let r=String(e);return r==="1"||r==="true"?!0:r==="0"||r==="false"?!1:t}function ye(e,t,r){let n=Object.values(t);return n.find(i=>Lr(i,e))??r??n[0]}function jc(e=""){return String(e).replace(/(\p{Lowercase_Letter})(\p{Uppercase_Letter})/gu,(t,r,n)=>`${r}-${n}`).replace(/\W+/gu,"-").toLowerCase()}function At(e,t=1){return _r(e)||(e=Number.parseInt(e,10)),!Number.isNaN(e)&&e>0&&Number.isFinite(e)?e:t}var Kc=Date.now(),si=()=>`(+${Date.now()-Kc}ms)`,wr=new Set,Yc=y(O("tacocat.debug",{},{metadata:!1}),typeof process<"u"&&process.env?.DEBUG);function da(e){let t=`[${sa}/${e}]`,r=(a,s,...c)=>a?!0:(i(s,...c),!1),n=Yc?(a,...s)=>{console.debug(`${t} ${a}`,...s,si())}:()=>{},i=(a,...s)=>{let c=`${t} ${a}`;wr.forEach(([h])=>h(c,...s))};return{assert:r,debug:n,error:i,warn:(a,...s)=>{let c=`${t} ${a}`;wr.forEach(([,h])=>h(c,...s))}}}function Xc(e,t){let r=[e,t];return wr.add(r),()=>{wr.delete(r)}}Xc((e,...t)=>{console.error(e,...t,si())},(e,...t)=>{console.warn(e,...t,si())});var Wc="no promo",ua="promo-tag",qc="yellow",Zc="neutral",Jc=(e,t,r)=>{let n=o=>o||Wc,i=r?` (was "${n(t)}")`:"";return`${n(e)}${i}`},Qc="cancel-context",Ht=(e,t)=>{let r=e===Qc,n=!r&&e?.length>0,i=(n||r)&&(t&&t!=e||!t&&!r),o=i&&n||!i&&!!t,a=o?e||t:void 0;return{effectivePromoCode:a,overridenPromoCode:e,className:o?ua:`${ua} no-promo`,text:Jc(a,t,i),variant:o?qc:Zc,isOverriden:i}};var ci="ABM",li="PUF",hi="M2M",di="PERPETUAL",ui="P3Y",el="TAX_INCLUSIVE_DETAILS",tl="TAX_EXCLUSIVE",ma={ABM:ci,PUF:li,M2M:hi,PERPETUAL:di,P3Y:ui},_m={[ci]:{commitment:D.YEAR,term:N.MONTHLY},[li]:{commitment:D.YEAR,term:N.ANNUAL},[hi]:{commitment:D.MONTH,term:N.MONTHLY},[di]:{commitment:D.PERPETUAL,term:void 0},[ui]:{commitment:D.THREE_MONTHS,term:N.P3Y}},pa="Value is not an offer",Pr=e=>{if(typeof e!="object")return pa;let{commitment:t,term:r}=e,n=rl(t,r);return{...e,planType:n}};var rl=(e,t)=>{switch(e){case void 0:return pa;case"":return"";case D.YEAR:return t===N.MONTHLY?ci:t===N.ANNUAL?li:"";case D.MONTH:return t===N.MONTHLY?hi:"";case D.PERPETUAL:return di;case D.TERM_LICENSE:return t===N.P3Y?ui:"";default:return""}};function mi(e){let{priceDetails:t}=e,{price:r,priceWithoutDiscount:n,priceWithoutTax:i,priceWithoutDiscountAndTax:o,taxDisplay:a}=t;if(a!==el)return e;let s={...e,priceDetails:{...t,price:i??r,priceWithoutDiscount:o??n,taxDisplay:tl}};return s.offerType==="TRIAL"&&s.priceDetails.price===0&&(s.priceDetails.price=s.priceDetails.priceWithoutDiscount),s}var pi=function(e,t){return pi=Object.setPrototypeOf||{__proto__:[]}instanceof Array&&function(r,n){r.__proto__=n}||function(r,n){for(var i in n)Object.prototype.hasOwnProperty.call(n,i)&&(r[i]=n[i])},pi(e,t)};function zt(e,t){if(typeof t!="function"&&t!==null)throw new TypeError("Class extends value "+String(t)+" is not a constructor or null");pi(e,t);function r(){this.constructor=e}e.prototype=t===null?Object.create(t):(r.prototype=t.prototype,new r)}var T=function(){return T=Object.assign||function(t){for(var r,n=1,i=arguments.length;n<i;n++){r=arguments[n];for(var o in r)Object.prototype.hasOwnProperty.call(r,o)&&(t[o]=r[o])}return t},T.apply(this,arguments)};function Cr(e,t,r){if(r||arguments.length===2)for(var n=0,i=t.length,o;n<i;n++)(o||!(n in t))&&(o||(o=Array.prototype.slice.call(t,0,n)),o[n]=t[n]);return e.concat(o||Array.prototype.slice.call(t))}var b;(function(e){e[e.EXPECT_ARGUMENT_CLOSING_BRACE=1]="EXPECT_ARGUMENT_CLOSING_BRACE",e[e.EMPTY_ARGUMENT=2]="EMPTY_ARGUMENT",e[e.MALFORMED_ARGUMENT=3]="MALFORMED_ARGUMENT",e[e.EXPECT_ARGUMENT_TYPE=4]="EXPECT_ARGUMENT_TYPE",e[e.INVALID_ARGUMENT_TYPE=5]="INVALID_ARGUMENT_TYPE",e[e.EXPECT_ARGUMENT_STYLE=6]="EXPECT_ARGUMENT_STYLE",e[e.INVALID_NUMBER_SKELETON=7]="INVALID_NUMBER_SKELETON",e[e.INVALID_DATE_TIME_SKELETON=8]="INVALID_DATE_TIME_SKELETON",e[e.EXPECT_NUMBER_SKELETON=9]="EXPECT_NUMBER_SKELETON",e[e.EXPECT_DATE_TIME_SKELETON=10]="EXPECT_DATE_TIME_SKELETON",e[e.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE=11]="UNCLOSED_QUOTE_IN_ARGUMENT_STYLE",e[e.EXPECT_SELECT_ARGUMENT_OPTIONS=12]="EXPECT_SELECT_ARGUMENT_OPTIONS",e[e.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE=13]="EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE=14]="INVALID_PLURAL_ARGUMENT_OFFSET_VALUE",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR=15]="EXPECT_SELECT_ARGUMENT_SELECTOR",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR=16]="EXPECT_PLURAL_ARGUMENT_SELECTOR",e[e.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT=17]="EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT",e[e.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT=18]="EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT",e[e.INVALID_PLURAL_ARGUMENT_SELECTOR=19]="INVALID_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_PLURAL_ARGUMENT_SELECTOR=20]="DUPLICATE_PLURAL_ARGUMENT_SELECTOR",e[e.DUPLICATE_SELECT_ARGUMENT_SELECTOR=21]="DUPLICATE_SELECT_ARGUMENT_SELECTOR",e[e.MISSING_OTHER_CLAUSE=22]="MISSING_OTHER_CLAUSE",e[e.INVALID_TAG=23]="INVALID_TAG",e[e.INVALID_TAG_NAME=25]="INVALID_TAG_NAME",e[e.UNMATCHED_CLOSING_TAG=26]="UNMATCHED_CLOSING_TAG",e[e.UNCLOSED_TAG=27]="UNCLOSED_TAG"})(b||(b={}));var P;(function(e){e[e.literal=0]="literal",e[e.argument=1]="argument",e[e.number=2]="number",e[e.date=3]="date",e[e.time=4]="time",e[e.select=5]="select",e[e.plural=6]="plural",e[e.pound=7]="pound",e[e.tag=8]="tag"})(P||(P={}));var ze;(function(e){e[e.number=0]="number",e[e.dateTime=1]="dateTime"})(ze||(ze={}));function fi(e){return e.type===P.literal}function fa(e){return e.type===P.argument}function Ir(e){return e.type===P.number}function kr(e){return e.type===P.date}function Nr(e){return e.type===P.time}function Or(e){return e.type===P.select}function Rr(e){return e.type===P.plural}function ga(e){return e.type===P.pound}function Vr(e){return e.type===P.tag}function $r(e){return!!(e&&typeof e=="object"&&e.type===ze.number)}function Ft(e){return!!(e&&typeof e=="object"&&e.type===ze.dateTime)}var gi=/[ \xA0\u1680\u2000-\u200A\u202F\u205F\u3000]/;var nl=/(?:[Eec]{1,6}|G{1,5}|[Qq]{1,5}|(?:[yYur]+|U{1,5})|[ML]{1,5}|d{1,2}|D{1,3}|F{1}|[abB]{1,5}|[hkHK]{1,2}|w{1,2}|W{1}|m{1,2}|s{1,2}|[zZOvVxX]{1,4})(?=([^']*'[^']*')*[^']*$)/g;function xa(e){var t={};return e.replace(nl,function(r){var n=r.length;switch(r[0]){case"G":t.era=n===4?"long":n===5?"narrow":"short";break;case"y":t.year=n===2?"2-digit":"numeric";break;case"Y":case"u":case"U":case"r":throw new RangeError("`Y/u/U/r` (year) patterns are not supported, use `y` instead");case"q":case"Q":throw new RangeError("`q/Q` (quarter) patterns are not supported");case"M":case"L":t.month=["numeric","2-digit","short","long","narrow"][n-1];break;case"w":case"W":throw new RangeError("`w/W` (week) patterns are not supported");case"d":t.day=["numeric","2-digit"][n-1];break;case"D":case"F":case"g":throw new RangeError("`D/F/g` (day) patterns are not supported, use `d` instead");case"E":t.weekday=n===4?"short":n===5?"narrow":"short";break;case"e":if(n<4)throw new RangeError("`e..eee` (weekday) patterns are not supported");t.weekday=["short","long","narrow","short"][n-4];break;case"c":if(n<4)throw new RangeError("`c..ccc` (weekday) patterns are not supported");t.weekday=["short","long","narrow","short"][n-4];break;case"a":t.hour12=!0;break;case"b":case"B":throw new RangeError("`b/B` (period) patterns are not supported, use `a` instead");case"h":t.hourCycle="h12",t.hour=["numeric","2-digit"][n-1];break;case"H":t.hourCycle="h23",t.hour=["numeric","2-digit"][n-1];break;case"K":t.hourCycle="h11",t.hour=["numeric","2-digit"][n-1];break;case"k":t.hourCycle="h24",t.hour=["numeric","2-digit"][n-1];break;case"j":case"J":case"C":throw new RangeError("`j/J/C` (hour) patterns are not supported, use `h/H/K/k` instead");case"m":t.minute=["numeric","2-digit"][n-1];break;case"s":t.second=["numeric","2-digit"][n-1];break;case"S":case"A":throw new RangeError("`S/A` (second) patterns are not supported, use `s` instead");case"z":t.timeZoneName=n<4?"short":"long";break;case"Z":case"O":case"v":case"V":case"X":case"x":throw new RangeError("`Z/O/v/V/X/x` (timeZone) patterns are not supported, use `z` instead")}return""}),t}var va=/[\t-\r \x85\u200E\u200F\u2028\u2029]/i;function Sa(e){if(e.length===0)throw new Error("Number skeleton cannot be empty");for(var t=e.split(va).filter(function(u){return u.length>0}),r=[],n=0,i=t;n<i.length;n++){var o=i[n],a=o.split("/");if(a.length===0)throw new Error("Invalid number skeleton");for(var s=a[0],c=a.slice(1),h=0,l=c;h<l.length;h++){var d=l[h];if(d.length===0)throw new Error("Invalid number skeleton")}r.push({stem:s,options:c})}return r}function il(e){return e.replace(/^(.*?)-/,"")}var ba=/^\.(?:(0+)(\*)?|(#+)|(0+)(#+))$/g,ya=/^(@+)?(\+|#+)?$/g,ol=/(\*)(0+)|(#+)(0+)|(0+)/g,Ta=/^(0+)$/;function Aa(e){var t={};return e.replace(ya,function(r,n,i){return typeof i!="string"?(t.minimumSignificantDigits=n.length,t.maximumSignificantDigits=n.length):i==="+"?t.minimumSignificantDigits=n.length:n[0]==="#"?t.maximumSignificantDigits=n.length:(t.minimumSignificantDigits=n.length,t.maximumSignificantDigits=n.length+(typeof i=="string"?i.length:0)),""}),t}function La(e){switch(e){case"sign-auto":return{signDisplay:"auto"};case"sign-accounting":case"()":return{currencySign:"accounting"};case"sign-always":case"+!":return{signDisplay:"always"};case"sign-accounting-always":case"()!":return{signDisplay:"always",currencySign:"accounting"};case"sign-except-zero":case"+?":return{signDisplay:"exceptZero"};case"sign-accounting-except-zero":case"()?":return{signDisplay:"exceptZero",currencySign:"accounting"};case"sign-never":case"+_":return{signDisplay:"never"}}}function al(e){var t;if(e[0]==="E"&&e[1]==="E"?(t={notation:"engineering"},e=e.slice(2)):e[0]==="E"&&(t={notation:"scientific"},e=e.slice(1)),t){var r=e.slice(0,2);if(r==="+!"?(t.signDisplay="always",e=e.slice(2)):r==="+?"&&(t.signDisplay="exceptZero",e=e.slice(2)),!Ta.test(e))throw new Error("Malformed concise eng/scientific notation");t.minimumIntegerDigits=e.length}return t}function Ea(e){var t={},r=La(e);return r||t}function _a(e){for(var t={},r=0,n=e;r<n.length;r++){var i=n[r];switch(i.stem){case"percent":case"%":t.style="percent";continue;case"%x100":t.style="percent",t.scale=100;continue;case"currency":t.style="currency",t.currency=i.options[0];continue;case"group-off":case",_":t.useGrouping=!1;continue;case"precision-integer":case".":t.maximumFractionDigits=0;continue;case"measure-unit":case"unit":t.style="unit",t.unit=il(i.options[0]);continue;case"compact-short":case"K":t.notation="compact",t.compactDisplay="short";continue;case"compact-long":case"KK":t.notation="compact",t.compactDisplay="long";continue;case"scientific":t=T(T(T({},t),{notation:"scientific"}),i.options.reduce(function(s,c){return T(T({},s),Ea(c))},{}));continue;case"engineering":t=T(T(T({},t),{notation:"engineering"}),i.options.reduce(function(s,c){return T(T({},s),Ea(c))},{}));continue;case"notation-simple":t.notation="standard";continue;case"unit-width-narrow":t.currencyDisplay="narrowSymbol",t.unitDisplay="narrow";continue;case"unit-width-short":t.currencyDisplay="code",t.unitDisplay="short";continue;case"unit-width-full-name":t.currencyDisplay="name",t.unitDisplay="long";continue;case"unit-width-iso-code":t.currencyDisplay="symbol";continue;case"scale":t.scale=parseFloat(i.options[0]);continue;case"integer-width":if(i.options.length>1)throw new RangeError("integer-width stems only accept a single optional option");i.options[0].replace(ol,function(s,c,h,l,d,u){if(c)t.minimumIntegerDigits=h.length;else{if(l&&d)throw new Error("We currently do not support maximum integer digits");if(u)throw new Error("We currently do not support exact integer digits")}return""});continue}if(Ta.test(i.stem)){t.minimumIntegerDigits=i.stem.length;continue}if(ba.test(i.stem)){if(i.options.length>1)throw new RangeError("Fraction-precision stems only accept a single optional option");i.stem.replace(ba,function(s,c,h,l,d,u){return h==="*"?t.minimumFractionDigits=c.length:l&&l[0]==="#"?t.maximumFractionDigits=l.length:d&&u?(t.minimumFractionDigits=d.length,t.maximumFractionDigits=d.length+u.length):(t.minimumFractionDigits=c.length,t.maximumFractionDigits=c.length),""}),i.options.length&&(t=T(T({},t),Aa(i.options[0])));continue}if(ya.test(i.stem)){t=T(T({},t),Aa(i.stem));continue}var o=La(i.stem);o&&(t=T(T({},t),o));var a=al(i.stem);a&&(t=T(T({},t),a))}return t}var xi,sl=new RegExp("^"+gi.source+"*"),cl=new RegExp(gi.source+"*$");function E(e,t){return{start:e,end:t}}var ll=!!String.prototype.startsWith,hl=!!String.fromCodePoint,dl=!!Object.fromEntries,ul=!!String.prototype.codePointAt,ml=!!String.prototype.trimStart,pl=!!String.prototype.trimEnd,fl=!!Number.isSafeInteger,gl=fl?Number.isSafeInteger:function(e){return typeof e=="number"&&isFinite(e)&&Math.floor(e)===e&&Math.abs(e)<=9007199254740991},bi=!0;try{wa=ka("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),bi=((xi=wa.exec("a"))===null||xi===void 0?void 0:xi[0])==="a"}catch{bi=!1}var wa,Pa=ll?function(t,r,n){return t.startsWith(r,n)}:function(t,r,n){return t.slice(n,n+r.length)===r},Ai=hl?String.fromCodePoint:function(){for(var t=[],r=0;r<arguments.length;r++)t[r]=arguments[r];for(var n="",i=t.length,o=0,a;i>o;){if(a=t[o++],a>1114111)throw RangeError(a+" is not a valid code point");n+=a<65536?String.fromCharCode(a):String.fromCharCode(((a-=65536)>>10)+55296,a%1024+56320)}return n},Ca=dl?Object.fromEntries:function(t){for(var r={},n=0,i=t;n<i.length;n++){var o=i[n],a=o[0],s=o[1];r[a]=s}return r},Ia=ul?function(t,r){return t.codePointAt(r)}:function(t,r){var n=t.length;if(!(r<0||r>=n)){var i=t.charCodeAt(r),o;return i<55296||i>56319||r+1===n||(o=t.charCodeAt(r+1))<56320||o>57343?i:(i-55296<<10)+(o-56320)+65536}},xl=ml?function(t){return t.trimStart()}:function(t){return t.replace(sl,"")},vl=pl?function(t){return t.trimEnd()}:function(t){return t.replace(cl,"")};function ka(e,t){return new RegExp(e,t)}var Ei;bi?(vi=ka("([^\\p{White_Space}\\p{Pattern_Syntax}]*)","yu"),Ei=function(t,r){var n;vi.lastIndex=r;var i=vi.exec(t);return(n=i[1])!==null&&n!==void 0?n:""}):Ei=function(t,r){for(var n=[];;){var i=Ia(t,r);if(i===void 0||Oa(i)||El(i))break;n.push(i),r+=i>=65536?2:1}return Ai.apply(void 0,n)};var vi,Na=function(){function e(t,r){r===void 0&&(r={}),this.message=t,this.position={offset:0,line:1,column:1},this.ignoreTag=!!r.ignoreTag,this.requiresOtherClause=!!r.requiresOtherClause,this.shouldParseSkeletons=!!r.shouldParseSkeletons}return e.prototype.parse=function(){if(this.offset()!==0)throw Error("parser can only be used once");return this.parseMessage(0,"",!1)},e.prototype.parseMessage=function(t,r,n){for(var i=[];!this.isEOF();){var o=this.char();if(o===123){var a=this.parseArgument(t,n);if(a.err)return a;i.push(a.val)}else{if(o===125&&t>0)break;if(o===35&&(r==="plural"||r==="selectordinal")){var s=this.clonePosition();this.bump(),i.push({type:P.pound,location:E(s,this.clonePosition())})}else if(o===60&&!this.ignoreTag&&this.peek()===47){if(n)break;return this.error(b.UNMATCHED_CLOSING_TAG,E(this.clonePosition(),this.clonePosition()))}else if(o===60&&!this.ignoreTag&&Si(this.peek()||0)){var a=this.parseTag(t,r);if(a.err)return a;i.push(a.val)}else{var a=this.parseLiteral(t,r);if(a.err)return a;i.push(a.val)}}}return{val:i,err:null}},e.prototype.parseTag=function(t,r){var n=this.clonePosition();this.bump();var i=this.parseTagName();if(this.bumpSpace(),this.bumpIf("/>"))return{val:{type:P.literal,value:"<"+i+"/>",location:E(n,this.clonePosition())},err:null};if(this.bumpIf(">")){var o=this.parseMessage(t+1,r,!0);if(o.err)return o;var a=o.val,s=this.clonePosition();if(this.bumpIf("</")){if(this.isEOF()||!Si(this.char()))return this.error(b.INVALID_TAG,E(s,this.clonePosition()));var c=this.clonePosition(),h=this.parseTagName();return i!==h?this.error(b.UNMATCHED_CLOSING_TAG,E(c,this.clonePosition())):(this.bumpSpace(),this.bumpIf(">")?{val:{type:P.tag,value:i,children:a,location:E(n,this.clonePosition())},err:null}:this.error(b.INVALID_TAG,E(s,this.clonePosition())))}else return this.error(b.UNCLOSED_TAG,E(n,this.clonePosition()))}else return this.error(b.INVALID_TAG,E(n,this.clonePosition()))},e.prototype.parseTagName=function(){var t=this.offset();for(this.bump();!this.isEOF()&&Al(this.char());)this.bump();return this.message.slice(t,this.offset())},e.prototype.parseLiteral=function(t,r){for(var n=this.clonePosition(),i="";;){var o=this.tryParseQuote(r);if(o){i+=o;continue}var a=this.tryParseUnquoted(t,r);if(a){i+=a;continue}var s=this.tryParseLeftAngleBracket();if(s){i+=s;continue}break}var c=E(n,this.clonePosition());return{val:{type:P.literal,value:i,location:c},err:null}},e.prototype.tryParseLeftAngleBracket=function(){return!this.isEOF()&&this.char()===60&&(this.ignoreTag||!bl(this.peek()||0))?(this.bump(),"<"):null},e.prototype.tryParseQuote=function(t){if(this.isEOF()||this.char()!==39)return null;switch(this.peek()){case 39:return this.bump(),this.bump(),"'";case 123:case 60:case 62:case 125:break;case 35:if(t==="plural"||t==="selectordinal")break;return null;default:return null}this.bump();var r=[this.char()];for(this.bump();!this.isEOF();){var n=this.char();if(n===39)if(this.peek()===39)r.push(39),this.bump();else{this.bump();break}else r.push(n);this.bump()}return Ai.apply(void 0,r)},e.prototype.tryParseUnquoted=function(t,r){if(this.isEOF())return null;var n=this.char();return n===60||n===123||n===35&&(r==="plural"||r==="selectordinal")||n===125&&t>0?null:(this.bump(),Ai(n))},e.prototype.parseArgument=function(t,r){var n=this.clonePosition();if(this.bump(),this.bumpSpace(),this.isEOF())return this.error(b.EXPECT_ARGUMENT_CLOSING_BRACE,E(n,this.clonePosition()));if(this.char()===125)return this.bump(),this.error(b.EMPTY_ARGUMENT,E(n,this.clonePosition()));var i=this.parseIdentifierIfPossible().value;if(!i)return this.error(b.MALFORMED_ARGUMENT,E(n,this.clonePosition()));if(this.bumpSpace(),this.isEOF())return this.error(b.EXPECT_ARGUMENT_CLOSING_BRACE,E(n,this.clonePosition()));switch(this.char()){case 125:return this.bump(),{val:{type:P.argument,value:i,location:E(n,this.clonePosition())},err:null};case 44:return this.bump(),this.bumpSpace(),this.isEOF()?this.error(b.EXPECT_ARGUMENT_CLOSING_BRACE,E(n,this.clonePosition())):this.parseArgumentOptions(t,r,i,n);default:return this.error(b.MALFORMED_ARGUMENT,E(n,this.clonePosition()))}},e.prototype.parseIdentifierIfPossible=function(){var t=this.clonePosition(),r=this.offset(),n=Ei(this.message,r),i=r+n.length;this.bumpTo(i);var o=this.clonePosition(),a=E(t,o);return{value:n,location:a}},e.prototype.parseArgumentOptions=function(t,r,n,i){var o,a=this.clonePosition(),s=this.parseIdentifierIfPossible().value,c=this.clonePosition();switch(s){case"":return this.error(b.EXPECT_ARGUMENT_TYPE,E(a,c));case"number":case"date":case"time":{this.bumpSpace();var h=null;if(this.bumpIf(",")){this.bumpSpace();var l=this.clonePosition(),d=this.parseSimpleArgStyleIfPossible();if(d.err)return d;var u=vl(d.val);if(u.length===0)return this.error(b.EXPECT_ARGUMENT_STYLE,E(this.clonePosition(),this.clonePosition()));var m=E(l,this.clonePosition());h={style:u,styleLocation:m}}var g=this.tryParseArgumentClose(i);if(g.err)return g;var f=E(i,this.clonePosition());if(h&&Pa(h?.style,"::",0)){var S=xl(h.style.slice(2));if(s==="number"){var d=this.parseNumberSkeletonFromString(S,h.styleLocation);return d.err?d:{val:{type:P.number,value:n,location:f,style:d.val},err:null}}else{if(S.length===0)return this.error(b.EXPECT_DATE_TIME_SKELETON,f);var u={type:ze.dateTime,pattern:S,location:h.styleLocation,parsedOptions:this.shouldParseSkeletons?xa(S):{}},w=s==="date"?P.date:P.time;return{val:{type:w,value:n,location:f,style:u},err:null}}}return{val:{type:s==="number"?P.number:s==="date"?P.date:P.time,value:n,location:f,style:(o=h?.style)!==null&&o!==void 0?o:null},err:null}}case"plural":case"selectordinal":case"select":{var v=this.clonePosition();if(this.bumpSpace(),!this.bumpIf(","))return this.error(b.EXPECT_SELECT_ARGUMENT_OPTIONS,E(v,T({},v)));this.bumpSpace();var A=this.parseIdentifierIfPossible(),R=0;if(s!=="select"&&A.value==="offset"){if(!this.bumpIf(":"))return this.error(b.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,E(this.clonePosition(),this.clonePosition()));this.bumpSpace();var d=this.tryParseDecimalInteger(b.EXPECT_PLURAL_ARGUMENT_OFFSET_VALUE,b.INVALID_PLURAL_ARGUMENT_OFFSET_VALUE);if(d.err)return d;this.bumpSpace(),A=this.parseIdentifierIfPossible(),R=d.val}var C=this.tryParsePluralOrSelectOptions(t,s,r,A);if(C.err)return C;var g=this.tryParseArgumentClose(i);if(g.err)return g;var $=E(i,this.clonePosition());return s==="select"?{val:{type:P.select,value:n,options:Ca(C.val),location:$},err:null}:{val:{type:P.plural,value:n,options:Ca(C.val),offset:R,pluralType:s==="plural"?"cardinal":"ordinal",location:$},err:null}}default:return this.error(b.INVALID_ARGUMENT_TYPE,E(a,c))}},e.prototype.tryParseArgumentClose=function(t){return this.isEOF()||this.char()!==125?this.error(b.EXPECT_ARGUMENT_CLOSING_BRACE,E(t,this.clonePosition())):(this.bump(),{val:!0,err:null})},e.prototype.parseSimpleArgStyleIfPossible=function(){for(var t=0,r=this.clonePosition();!this.isEOF();){var n=this.char();switch(n){case 39:{this.bump();var i=this.clonePosition();if(!this.bumpUntil("'"))return this.error(b.UNCLOSED_QUOTE_IN_ARGUMENT_STYLE,E(i,this.clonePosition()));this.bump();break}case 123:{t+=1,this.bump();break}case 125:{if(t>0)t-=1;else return{val:this.message.slice(r.offset,this.offset()),err:null};break}default:this.bump();break}}return{val:this.message.slice(r.offset,this.offset()),err:null}},e.prototype.parseNumberSkeletonFromString=function(t,r){var n=[];try{n=Sa(t)}catch{return this.error(b.INVALID_NUMBER_SKELETON,r)}return{val:{type:ze.number,tokens:n,location:r,parsedOptions:this.shouldParseSkeletons?_a(n):{}},err:null}},e.prototype.tryParsePluralOrSelectOptions=function(t,r,n,i){for(var o,a=!1,s=[],c=new Set,h=i.value,l=i.location;;){if(h.length===0){var d=this.clonePosition();if(r!=="select"&&this.bumpIf("=")){var u=this.tryParseDecimalInteger(b.EXPECT_PLURAL_ARGUMENT_SELECTOR,b.INVALID_PLURAL_ARGUMENT_SELECTOR);if(u.err)return u;l=E(d,this.clonePosition()),h=this.message.slice(d.offset,this.offset())}else break}if(c.has(h))return this.error(r==="select"?b.DUPLICATE_SELECT_ARGUMENT_SELECTOR:b.DUPLICATE_PLURAL_ARGUMENT_SELECTOR,l);h==="other"&&(a=!0),this.bumpSpace();var m=this.clonePosition();if(!this.bumpIf("{"))return this.error(r==="select"?b.EXPECT_SELECT_ARGUMENT_SELECTOR_FRAGMENT:b.EXPECT_PLURAL_ARGUMENT_SELECTOR_FRAGMENT,E(this.clonePosition(),this.clonePosition()));var g=this.parseMessage(t+1,r,n);if(g.err)return g;var f=this.tryParseArgumentClose(m);if(f.err)return f;s.push([h,{value:g.val,location:E(m,this.clonePosition())}]),c.add(h),this.bumpSpace(),o=this.parseIdentifierIfPossible(),h=o.value,l=o.location}return s.length===0?this.error(r==="select"?b.EXPECT_SELECT_ARGUMENT_SELECTOR:b.EXPECT_PLURAL_ARGUMENT_SELECTOR,E(this.clonePosition(),this.clonePosition())):this.requiresOtherClause&&!a?this.error(b.MISSING_OTHER_CLAUSE,E(this.clonePosition(),this.clonePosition())):{val:s,err:null}},e.prototype.tryParseDecimalInteger=function(t,r){var n=1,i=this.clonePosition();this.bumpIf("+")||this.bumpIf("-")&&(n=-1);for(var o=!1,a=0;!this.isEOF();){var s=this.char();if(s>=48&&s<=57)o=!0,a=a*10+(s-48),this.bump();else break}var c=E(i,this.clonePosition());return o?(a*=n,gl(a)?{val:a,err:null}:this.error(r,c)):this.error(t,c)},e.prototype.offset=function(){return this.position.offset},e.prototype.isEOF=function(){return this.offset()===this.message.length},e.prototype.clonePosition=function(){return{offset:this.position.offset,line:this.position.line,column:this.position.column}},e.prototype.char=function(){var t=this.position.offset;if(t>=this.message.length)throw Error("out of bound");var r=Ia(this.message,t);if(r===void 0)throw Error("Offset "+t+" is at invalid UTF-16 code unit boundary");return r},e.prototype.error=function(t,r){return{val:null,err:{kind:t,message:this.message,location:r}}},e.prototype.bump=function(){if(!this.isEOF()){var t=this.char();t===10?(this.position.line+=1,this.position.column=1,this.position.offset+=1):(this.position.column+=1,this.position.offset+=t<65536?1:2)}},e.prototype.bumpIf=function(t){if(Pa(this.message,t,this.offset())){for(var r=0;r<t.length;r++)this.bump();return!0}return!1},e.prototype.bumpUntil=function(t){var r=this.offset(),n=this.message.indexOf(t,r);return n>=0?(this.bumpTo(n),!0):(this.bumpTo(this.message.length),!1)},e.prototype.bumpTo=function(t){if(this.offset()>t)throw Error("targetOffset "+t+" must be greater than or equal to the current offset "+this.offset());for(t=Math.min(t,this.message.length);;){var r=this.offset();if(r===t)break;if(r>t)throw Error("targetOffset "+t+" is at invalid UTF-16 code unit boundary");if(this.bump(),this.isEOF())break}},e.prototype.bumpSpace=function(){for(;!this.isEOF()&&Oa(this.char());)this.bump()},e.prototype.peek=function(){if(this.isEOF())return null;var t=this.char(),r=this.offset(),n=this.message.charCodeAt(r+(t>=65536?2:1));return n??null},e}();function Si(e){return e>=97&&e<=122||e>=65&&e<=90}function bl(e){return Si(e)||e===47}function Al(e){return e===45||e===46||e>=48&&e<=57||e===95||e>=97&&e<=122||e>=65&&e<=90||e==183||e>=192&&e<=214||e>=216&&e<=246||e>=248&&e<=893||e>=895&&e<=8191||e>=8204&&e<=8205||e>=8255&&e<=8256||e>=8304&&e<=8591||e>=11264&&e<=12271||e>=12289&&e<=55295||e>=63744&&e<=64975||e>=65008&&e<=65533||e>=65536&&e<=983039}function Oa(e){return e>=9&&e<=13||e===32||e===133||e>=8206&&e<=8207||e===8232||e===8233}function El(e){return e>=33&&e<=35||e===36||e>=37&&e<=39||e===40||e===41||e===42||e===43||e===44||e===45||e>=46&&e<=47||e>=58&&e<=59||e>=60&&e<=62||e>=63&&e<=64||e===91||e===92||e===93||e===94||e===96||e===123||e===124||e===125||e===126||e===161||e>=162&&e<=165||e===166||e===167||e===169||e===171||e===172||e===174||e===176||e===177||e===182||e===187||e===191||e===215||e===247||e>=8208&&e<=8213||e>=8214&&e<=8215||e===8216||e===8217||e===8218||e>=8219&&e<=8220||e===8221||e===8222||e===8223||e>=8224&&e<=8231||e>=8240&&e<=8248||e===8249||e===8250||e>=8251&&e<=8254||e>=8257&&e<=8259||e===8260||e===8261||e===8262||e>=8263&&e<=8273||e===8274||e===8275||e>=8277&&e<=8286||e>=8592&&e<=8596||e>=8597&&e<=8601||e>=8602&&e<=8603||e>=8604&&e<=8607||e===8608||e>=8609&&e<=8610||e===8611||e>=8612&&e<=8613||e===8614||e>=8615&&e<=8621||e===8622||e>=8623&&e<=8653||e>=8654&&e<=8655||e>=8656&&e<=8657||e===8658||e===8659||e===8660||e>=8661&&e<=8691||e>=8692&&e<=8959||e>=8960&&e<=8967||e===8968||e===8969||e===8970||e===8971||e>=8972&&e<=8991||e>=8992&&e<=8993||e>=8994&&e<=9e3||e===9001||e===9002||e>=9003&&e<=9083||e===9084||e>=9085&&e<=9114||e>=9115&&e<=9139||e>=9140&&e<=9179||e>=9180&&e<=9185||e>=9186&&e<=9254||e>=9255&&e<=9279||e>=9280&&e<=9290||e>=9291&&e<=9311||e>=9472&&e<=9654||e===9655||e>=9656&&e<=9664||e===9665||e>=9666&&e<=9719||e>=9720&&e<=9727||e>=9728&&e<=9838||e===9839||e>=9840&&e<=10087||e===10088||e===10089||e===10090||e===10091||e===10092||e===10093||e===10094||e===10095||e===10096||e===10097||e===10098||e===10099||e===10100||e===10101||e>=10132&&e<=10175||e>=10176&&e<=10180||e===10181||e===10182||e>=10183&&e<=10213||e===10214||e===10215||e===10216||e===10217||e===10218||e===10219||e===10220||e===10221||e===10222||e===10223||e>=10224&&e<=10239||e>=10240&&e<=10495||e>=10496&&e<=10626||e===10627||e===10628||e===10629||e===10630||e===10631||e===10632||e===10633||e===10634||e===10635||e===10636||e===10637||e===10638||e===10639||e===10640||e===10641||e===10642||e===10643||e===10644||e===10645||e===10646||e===10647||e===10648||e>=10649&&e<=10711||e===10712||e===10713||e===10714||e===10715||e>=10716&&e<=10747||e===10748||e===10749||e>=10750&&e<=11007||e>=11008&&e<=11055||e>=11056&&e<=11076||e>=11077&&e<=11078||e>=11079&&e<=11084||e>=11085&&e<=11123||e>=11124&&e<=11125||e>=11126&&e<=11157||e===11158||e>=11159&&e<=11263||e>=11776&&e<=11777||e===11778||e===11779||e===11780||e===11781||e>=11782&&e<=11784||e===11785||e===11786||e===11787||e===11788||e===11789||e>=11790&&e<=11798||e===11799||e>=11800&&e<=11801||e===11802||e===11803||e===11804||e===11805||e>=11806&&e<=11807||e===11808||e===11809||e===11810||e===11811||e===11812||e===11813||e===11814||e===11815||e===11816||e===11817||e>=11818&&e<=11822||e===11823||e>=11824&&e<=11833||e>=11834&&e<=11835||e>=11836&&e<=11839||e===11840||e===11841||e===11842||e>=11843&&e<=11855||e>=11856&&e<=11857||e===11858||e>=11859&&e<=11903||e>=12289&&e<=12291||e===12296||e===12297||e===12298||e===12299||e===12300||e===12301||e===12302||e===12303||e===12304||e===12305||e>=12306&&e<=12307||e===12308||e===12309||e===12310||e===12311||e===12312||e===12313||e===12314||e===12315||e===12316||e===12317||e>=12318&&e<=12319||e===12320||e===12336||e===64830||e===64831||e>=65093&&e<=65094}function yi(e){e.forEach(function(t){if(delete t.location,Or(t)||Rr(t))for(var r in t.options)delete t.options[r].location,yi(t.options[r].value);else Ir(t)&&$r(t.style)||(kr(t)||Nr(t))&&Ft(t.style)?delete t.style.location:Vr(t)&&yi(t.children)})}function Ra(e,t){t===void 0&&(t={}),t=T({shouldParseSkeletons:!0,requiresOtherClause:!0},t);var r=new Na(e,t).parse();if(r.err){var n=SyntaxError(b[r.err.kind]);throw n.location=r.err.location,n.originalMessage=r.err.message,n}return t?.captureLocation||yi(r.val),r.val}function Bt(e,t){var r=t&&t.cache?t.cache:wl,n=t&&t.serializer?t.serializer:_l,i=t&&t.strategy?t.strategy:yl;return i(e,{cache:r,serializer:n})}function Sl(e){return e==null||typeof e=="number"||typeof e=="boolean"}function Va(e,t,r,n){var i=Sl(n)?n:r(n),o=t.get(i);return typeof o>"u"&&(o=e.call(this,n),t.set(i,o)),o}function $a(e,t,r){var n=Array.prototype.slice.call(arguments,3),i=r(n),o=t.get(i);return typeof o>"u"&&(o=e.apply(this,n),t.set(i,o)),o}function Ti(e,t,r,n,i){return r.bind(t,e,n,i)}function yl(e,t){var r=e.length===1?Va:$a;return Ti(e,this,r,t.cache.create(),t.serializer)}function Tl(e,t){return Ti(e,this,$a,t.cache.create(),t.serializer)}function Ll(e,t){return Ti(e,this,Va,t.cache.create(),t.serializer)}var _l=function(){return JSON.stringify(arguments)};function Li(){this.cache=Object.create(null)}Li.prototype.get=function(e){return this.cache[e]};Li.prototype.set=function(e,t){this.cache[e]=t};var wl={create:function(){return new Li}},Mr={variadic:Tl,monadic:Ll};var Fe;(function(e){e.MISSING_VALUE="MISSING_VALUE",e.INVALID_VALUE="INVALID_VALUE",e.MISSING_INTL_API="MISSING_INTL_API"})(Fe||(Fe={}));var jt=function(e){zt(t,e);function t(r,n,i){var o=e.call(this,r)||this;return o.code=n,o.originalMessage=i,o}return t.prototype.toString=function(){return"[formatjs Error: "+this.code+"] "+this.message},t}(Error);var _i=function(e){zt(t,e);function t(r,n,i,o){return e.call(this,'Invalid values for "'+r+'": "'+n+'". Options are "'+Object.keys(i).join('", "')+'"',Fe.INVALID_VALUE,o)||this}return t}(jt);var Ma=function(e){zt(t,e);function t(r,n,i){return e.call(this,'Value for "'+r+'" must be of type '+n,Fe.INVALID_VALUE,i)||this}return t}(jt);var Ua=function(e){zt(t,e);function t(r,n){return e.call(this,'The intl string context variable "'+r+'" was not provided to the string "'+n+'"',Fe.MISSING_VALUE,n)||this}return t}(jt);var K;(function(e){e[e.literal=0]="literal",e[e.object=1]="object"})(K||(K={}));function Pl(e){return e.length<2?e:e.reduce(function(t,r){var n=t[t.length-1];return!n||n.type!==K.literal||r.type!==K.literal?t.push(r):n.value+=r.value,t},[])}function Cl(e){return typeof e=="function"}function Kt(e,t,r,n,i,o,a){if(e.length===1&&fi(e[0]))return[{type:K.literal,value:e[0].value}];for(var s=[],c=0,h=e;c<h.length;c++){var l=h[c];if(fi(l)){s.push({type:K.literal,value:l.value});continue}if(ga(l)){typeof o=="number"&&s.push({type:K.literal,value:r.getNumberFormat(t).format(o)});continue}var d=l.value;if(!(i&&d in i))throw new Ua(d,a);var u=i[d];if(fa(l)){(!u||typeof u=="string"||typeof u=="number")&&(u=typeof u=="string"||typeof u=="number"?String(u):""),s.push({type:typeof u=="string"?K.literal:K.object,value:u});continue}if(kr(l)){var m=typeof l.style=="string"?n.date[l.style]:Ft(l.style)?l.style.parsedOptions:void 0;s.push({type:K.literal,value:r.getDateTimeFormat(t,m).format(u)});continue}if(Nr(l)){var m=typeof l.style=="string"?n.time[l.style]:Ft(l.style)?l.style.parsedOptions:void 0;s.push({type:K.literal,value:r.getDateTimeFormat(t,m).format(u)});continue}if(Ir(l)){var m=typeof l.style=="string"?n.number[l.style]:$r(l.style)?l.style.parsedOptions:void 0;m&&m.scale&&(u=u*(m.scale||1)),s.push({type:K.literal,value:r.getNumberFormat(t,m).format(u)});continue}if(Vr(l)){var g=l.children,f=l.value,S=i[f];if(!Cl(S))throw new Ma(f,"function",a);var w=Kt(g,t,r,n,i,o),v=S(w.map(function(C){return C.value}));Array.isArray(v)||(v=[v]),s.push.apply(s,v.map(function(C){return{type:typeof C=="string"?K.literal:K.object,value:C}}))}if(Or(l)){var A=l.options[u]||l.options.other;if(!A)throw new _i(l.value,u,Object.keys(l.options),a);s.push.apply(s,Kt(A.value,t,r,n,i));continue}if(Rr(l)){var A=l.options["="+u];if(!A){if(!Intl.PluralRules)throw new jt(`Intl.PluralRules is not available in this environment.
Try polyfilling it using "@formatjs/intl-pluralrules"
`,Fe.MISSING_INTL_API,a);var R=r.getPluralRules(t,{type:l.pluralType}).select(u-(l.offset||0));A=l.options[R]||l.options.other}if(!A)throw new _i(l.value,u,Object.keys(l.options),a);s.push.apply(s,Kt(A.value,t,r,n,i,u-(l.offset||0)));continue}}return Pl(s)}function Il(e,t){return t?T(T(T({},e||{}),t||{}),Object.keys(e).reduce(function(r,n){return r[n]=T(T({},e[n]),t[n]||{}),r},{})):e}function kl(e,t){return t?Object.keys(e).reduce(function(r,n){return r[n]=Il(e[n],t[n]),r},T({},e)):e}function wi(e){return{create:function(){return{get:function(t){return e[t]},set:function(t,r){e[t]=r}}}}}function Nl(e){return e===void 0&&(e={number:{},dateTime:{},pluralRules:{}}),{getNumberFormat:Bt(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.NumberFormat).bind.apply(t,Cr([void 0],r)))},{cache:wi(e.number),strategy:Mr.variadic}),getDateTimeFormat:Bt(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.DateTimeFormat).bind.apply(t,Cr([void 0],r)))},{cache:wi(e.dateTime),strategy:Mr.variadic}),getPluralRules:Bt(function(){for(var t,r=[],n=0;n<arguments.length;n++)r[n]=arguments[n];return new((t=Intl.PluralRules).bind.apply(t,Cr([void 0],r)))},{cache:wi(e.pluralRules),strategy:Mr.variadic})}}var Da=function(){function e(t,r,n,i){var o=this;if(r===void 0&&(r=e.defaultLocale),this.formatterCache={number:{},dateTime:{},pluralRules:{}},this.format=function(a){var s=o.formatToParts(a);if(s.length===1)return s[0].value;var c=s.reduce(function(h,l){return!h.length||l.type!==K.literal||typeof h[h.length-1]!="string"?h.push(l.value):h[h.length-1]+=l.value,h},[]);return c.length<=1?c[0]||"":c},this.formatToParts=function(a){return Kt(o.ast,o.locales,o.formatters,o.formats,a,void 0,o.message)},this.resolvedOptions=function(){return{locale:Intl.NumberFormat.supportedLocalesOf(o.locales)[0]}},this.getAst=function(){return o.ast},typeof t=="string"){if(this.message=t,!e.__parse)throw new TypeError("IntlMessageFormat.__parse must be set to process `message` of type `string`");this.ast=e.__parse(t,{ignoreTag:i?.ignoreTag})}else this.ast=t;if(!Array.isArray(this.ast))throw new TypeError("A message must be provided as a String or AST.");this.formats=kl(e.formats,n),this.locales=r,this.formatters=i&&i.formatters||Nl(this.formatterCache)}return Object.defineProperty(e,"defaultLocale",{get:function(){return e.memoizedDefaultLocale||(e.memoizedDefaultLocale=new Intl.NumberFormat().resolvedOptions().locale),e.memoizedDefaultLocale},enumerable:!1,configurable:!0}),e.memoizedDefaultLocale=null,e.__parse=Ra,e.formats={number:{integer:{maximumFractionDigits:0},currency:{style:"currency"},percent:{style:"percent"}},date:{short:{month:"numeric",day:"numeric",year:"2-digit"},medium:{month:"short",day:"numeric",year:"numeric"},long:{month:"long",day:"numeric",year:"numeric"},full:{weekday:"long",month:"long",day:"numeric",year:"numeric"}},time:{short:{hour:"numeric",minute:"numeric"},medium:{hour:"numeric",minute:"numeric",second:"numeric"},long:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"},full:{hour:"numeric",minute:"numeric",second:"numeric",timeZoneName:"short"}}},e}();var Ga=Da;var Ol=/[0-9\-+#]/,Rl=/[^\d\-+#]/g;function Ha(e){return e.search(Ol)}function Vl(e="#.##"){let t={},r=e.length,n=Ha(e);t.prefix=n>0?e.substring(0,n):"";let i=Ha(e.split("").reverse().join("")),o=r-i,a=e.substring(o,o+1),s=o+(a==="."||a===","?1:0);t.suffix=i>0?e.substring(s,r):"",t.mask=e.substring(n,s),t.maskHasNegativeSign=t.mask.charAt(0)==="-",t.maskHasPositiveSign=t.mask.charAt(0)==="+";let c=t.mask.match(Rl);return t.decimal=c&&c[c.length-1]||".",t.separator=c&&c[1]&&c[0]||",",c=t.mask.split(t.decimal),t.integer=c[0],t.fraction=c[1],t}function $l(e,t,r){let n=!1,i={value:e};e<0&&(n=!0,i.value=-i.value),i.sign=n?"-":"",i.value=Number(i.value).toFixed(t.fraction&&t.fraction.length),i.value=Number(i.value).toString();let o=t.fraction&&t.fraction.lastIndexOf("0"),[a="0",s=""]=i.value.split(".");return(!s||s&&s.length<=o)&&(s=o<0?"":(+("0."+s)).toFixed(o+1).replace("0.","")),i.integer=a,i.fraction=s,Ml(i,t),(i.result==="0"||i.result==="")&&(n=!1,i.sign=""),!n&&t.maskHasPositiveSign?i.sign="+":n&&t.maskHasPositiveSign?i.sign="-":n&&(i.sign=r&&r.enforceMaskSign&&!t.maskHasNegativeSign?"":"-"),i}function Ml(e,t){e.result="";let r=t.integer.split(t.separator),n=r.join(""),i=n&&n.indexOf("0");if(i>-1)for(;e.integer.length<n.length-i;)e.integer="0"+e.integer;else Number(e.integer)===0&&(e.integer="");let o=r[1]&&r[r.length-1].length;if(o){let a=e.integer.length,s=a%o;for(let c=0;c<a;c++)e.result+=e.integer.charAt(c),!((c-s+1)%o)&&c<a-o&&(e.result+=t.separator)}else e.result=e.integer;return e.result+=t.fraction&&e.fraction?t.decimal+e.fraction:"",e}function Ul(e,t,r={}){if(!e||isNaN(Number(t)))return t;let n=Vl(e),i=$l(t,n,r);return n.prefix+i.sign+i.result+n.suffix}var za=Ul;var Fa=".",Dl=",",ja=/^\s+/,Ka=/\s+$/,Ba="&nbsp;",Yt={MONTH:"MONTH",YEAR:"YEAR"},Gl={[N.ANNUAL]:12,[N.MONTHLY]:1,[N.THREE_YEARS]:36,[N.TWO_YEARS]:24},Hl={CHF:e=>Math.round(e*20)/20},Pi=(e,t)=>({accept:e,round:t}),zl=[Pi(({divisor:e,price:t})=>t%e==0,({divisor:e,price:t})=>t/e),Pi(({usePrecision:e})=>e,({divisor:e,price:t})=>Math.ceil(Math.floor(t*1e4/e)/100)/100),Pi(()=>!0,({divisor:e,price:t})=>Math.ceil(Math.floor(t*100/e)/100))],Ci={[D.YEAR]:{[N.MONTHLY]:Yt.MONTH,[N.ANNUAL]:Yt.YEAR},[D.MONTH]:{[N.MONTHLY]:Yt.MONTH}},Fl=(e,t)=>e.indexOf(`'${t}'`)===0,Bl=(e,t=!0)=>{let r=e.replace(/'.*?'/,"").trim(),n=Xa(r);return!!n?t||(r=r.replace(/[,\.]0+/,n)):r=r.replace(/\s?(#.*0)(?!\s)?/,"$&"+Kl(e)),r},jl=e=>{let t=Yl(e),r=Fl(e,t),n=e.replace(/'.*?'/,""),i=ja.test(n)||Ka.test(n);return{currencySymbol:t,isCurrencyFirst:r,hasCurrencySpace:i}},Ya=e=>e.replace(ja,Ba).replace(Ka,Ba),Kl=e=>e.match(/#(.?)#/)?.[1]===Fa?Dl:Fa,Yl=e=>e.match(/'(.*?)'/)?.[1]??"",Xa=e=>e.match(/0(.?)0/)?.[1]??"";function Ur({formatString:e,price:t,usePrecision:r,isIndianPrice:n=!1},i,o=a=>a){let{currencySymbol:a,isCurrencyFirst:s,hasCurrencySpace:c}=jl(e),h=r?Xa(e):"",l=Bl(e,r),d=r?2:0,u=o(t,{currencySymbol:a}),m=n?u.toLocaleString("hi-IN",{minimumFractionDigits:d,maximumFractionDigits:d}):za(l,u),g=r?m.lastIndexOf(h):m.length,f=m.substring(0,g),S=m.substring(g+1);return{accessiblePrice:e.replace(/'.*?'/,"SYMBOL").replace(/#.*0/,m).replace(/SYMBOL/,a),currencySymbol:a,decimals:S,decimalsDelimiter:h,hasCurrencySpace:c,integer:f,isCurrencyFirst:s,recurrenceTerm:i}}var Wa=e=>{let{commitment:t,term:r,usePrecision:n}=e,i=Gl[r]??1;return Ur(e,i>1?Yt.MONTH:Ci[t]?.[r],(o,{currencySymbol:a})=>{let s={divisor:i,price:o,usePrecision:n},{round:c}=zl.find(({accept:l})=>l(s));if(!c)throw new Error(`Missing rounding rule for: ${JSON.stringify(s)}`);return(Hl[a]??(l=>l))(c(s))})},qa=({commitment:e,term:t,...r})=>Ur(r,Ci[e]?.[t]),Za=e=>{let{commitment:t,term:r}=e;return t===D.YEAR&&r===N.MONTHLY?Ur(e,Yt.YEAR,n=>n*12):Ur(e,Ci[t]?.[r])};var Xl={recurrenceLabel:"{recurrenceTerm, select, MONTH {/mo} YEAR {/yr} other {}}",recurrenceAriaLabel:"{recurrenceTerm, select, MONTH {per month} YEAR {per year} other {}}",perUnitLabel:"{perUnit, select, LICENSE {per license} other {}}",perUnitAriaLabel:"{perUnit, select, LICENSE {per license} other {}}",freeLabel:"Free",freeAriaLabel:"Free",taxExclusiveLabel:"{taxTerm, select, GST {excl. GST} VAT {excl. VAT} TAX {excl. tax} IVA {excl. IVA} SST {excl. SST} KDV {excl. KDV} other {}}",taxInclusiveLabel:"{taxTerm, select, GST {incl. GST} VAT {incl. VAT} TAX {incl. tax} IVA {incl. IVA} SST {incl. SST} KDV {incl. KDV} other {}}",alternativePriceAriaLabel:"Alternatively at {alternativePrice}",strikethroughAriaLabel:"Regularly at {strikethroughPrice}"},Wl=da("ConsonantTemplates/price"),ql=/<\/?[^>]+(>|$)/g,z={container:"price",containerOptical:"price-optical",containerStrikethrough:"price-strikethrough",containerAnnual:"price-annual",containerAnnualPrefix:"price-annual-prefix",containerAnnualSuffix:"price-annual-suffix",disabled:"disabled",currencySpace:"price-currency-space",currencySymbol:"price-currency-symbol",decimals:"price-decimals",decimalsDelimiter:"price-decimals-delimiter",integer:"price-integer",recurrence:"price-recurrence",taxInclusivity:"price-tax-inclusivity",unitType:"price-unit-type"},Be={perUnitLabel:"perUnitLabel",perUnitAriaLabel:"perUnitAriaLabel",recurrenceLabel:"recurrenceLabel",recurrenceAriaLabel:"recurrenceAriaLabel",taxExclusiveLabel:"taxExclusiveLabel",taxInclusiveLabel:"taxInclusiveLabel",strikethroughAriaLabel:"strikethroughAriaLabel"},Zl="TAX_EXCLUSIVE",Jl=e=>ha(e)?Object.entries(e).filter(([,t])=>gt(t)||_r(t)||t===!0).reduce((t,[r,n])=>t+` ${r}${n===!0?"":'="'+ca(n)+'"'}`,""):"",Y=(e,t,r,n=!1)=>`<span class="${e}${t?"":" "+z.disabled}"${Jl(r)}>${n?Ya(t):t??""}</span>`;function Ql(e,{accessibleLabel:t,currencySymbol:r,decimals:n,decimalsDelimiter:i,hasCurrencySpace:o,integer:a,isCurrencyFirst:s,recurrenceLabel:c,perUnitLabel:h,taxInclusivityLabel:l},d={}){let u=Y(z.currencySymbol,r),m=Y(z.currencySpace,o?"&nbsp;":""),g="";return s&&(g+=u+m),g+=Y(z.integer,a),g+=Y(z.decimalsDelimiter,i),g+=Y(z.decimals,n),s||(g+=m+u),g+=Y(z.recurrence,c,null,!0),g+=Y(z.unitType,h,null,!0),g+=Y(z.taxInclusivity,l,!0),Y(e,g,{...d,"aria-label":t})}var W=({displayOptical:e=!1,displayStrikethrough:t=!1,displayAnnual:r=!1}={})=>({country:n,displayFormatted:i=!0,displayRecurrence:o=!0,displayPerUnit:a=!1,displayTax:s=!1,language:c,literals:h={}}={},{commitment:l,offerSelectorIds:d,formatString:u,price:m,priceWithoutDiscount:g,taxDisplay:f,taxTerm:S,term:w,usePrecision:v}={},A={})=>{Object.entries({country:n,formatString:u,language:c,price:m}).forEach(([ce,jr])=>{if(jr==null)throw new Error(`Argument "${ce}" is missing for osi ${d?.toString()}, country ${n}, language ${c}`)});let R={...Xl,...h},C=`${c.toLowerCase()}-${n.toUpperCase()}`;function $(ce,jr){let Kr=R[ce];if(Kr==null)return"";try{return new Ga(Kr.replace(ql,""),C).format(jr)}catch{return Wl.error("Failed to format literal:",Kr),""}}let F=t&&g?g:m,ae=e?Wa:qa;r&&(ae=Za);let{accessiblePrice:Ye,recurrenceTerm:Le,...Xe}=ae({commitment:l,formatString:u,term:w,price:e?m:F,usePrecision:v,isIndianPrice:n==="IN"}),J=Ye,fe="";if(y(o)&&Le){let ce=$(Be.recurrenceAriaLabel,{recurrenceTerm:Le});ce&&(J+=" "+ce),fe=$(Be.recurrenceLabel,{recurrenceTerm:Le})}let se="";if(y(a)){se=$(Be.perUnitLabel,{perUnit:"LICENSE"});let ce=$(Be.perUnitAriaLabel,{perUnit:"LICENSE"});ce&&(J+=" "+ce)}let Q="";y(s)&&S&&(Q=$(f===Zl?Be.taxExclusiveLabel:Be.taxInclusiveLabel,{taxTerm:S}),Q&&(J+=" "+Q)),t&&(J=$(Be.strikethroughAriaLabel,{strikethroughPrice:J}));let _e=z.container;if(e&&(_e+=" "+z.containerOptical),t&&(_e+=" "+z.containerStrikethrough),r&&(_e+=" "+z.containerAnnual),y(i))return Ql(_e,{...Xe,accessibleLabel:J,recurrenceLabel:fe,perUnitLabel:se,taxInclusivityLabel:Q},A);let{currencySymbol:Yi,decimals:xs,decimalsDelimiter:vs,hasCurrencySpace:Xi,integer:bs,isCurrencyFirst:As}=Xe,We=[bs,vs,xs];As?(We.unshift(Xi?"\xA0":""),We.unshift(Yi)):(We.push(Xi?"\xA0":""),We.push(Yi)),We.push(fe,se,Q);let Es=We.join("");return Y(_e,Es,A)},Ja=()=>(e,t,r)=>{let i=(e.displayOldPrice===void 0||y(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price;return`${W()(e,t,r)}${i?"&nbsp;"+W({displayStrikethrough:!0})(e,t,r):""}`},Qa=()=>(e,t,r)=>{let n={...e,displayTax:!1,displayPerUnit:!1};return`${(e.displayOldPrice===void 0||y(e.displayOldPrice))&&t.priceWithoutDiscount&&t.priceWithoutDiscount!=t.price?W({displayStrikethrough:!0})(n,t,r)+"&nbsp;":""}${W()(e,t,r)}${Y(z.containerAnnualPrefix,"&nbsp;(")}${W({displayAnnual:!0})(n,t,r)}${Y(z.containerAnnualSuffix,")")}`},es=()=>(e,t,r)=>{let n={...e,displayTax:!1,displayPerUnit:!1};return`${W()(e,t,r)}${Y(z.containerAnnualPrefix,"&nbsp;(")}${W({displayAnnual:!0})(n,t,r)}${Y(z.containerAnnualSuffix,")")}`};var Ii=W(),ki=Ja(),Ni=W({displayOptical:!0}),Oi=W({displayStrikethrough:!0}),Ri=W({displayAnnual:!0}),Vi=es(),$i=Qa();var eh=(e,t)=>{if(!(!vt(e)||!vt(t)))return Math.floor((t-e)/t*100)},ts=()=>(e,t)=>{let{price:r,priceWithoutDiscount:n}=t,i=eh(r,n);return i===void 0?'<span class="no-discount"></span>':`<span class="discount">${i}%</span>`};var Mi=ts();var{freeze:Xt}=Object,re=Xt({...He}),ne=Xt({...Z}),je={STAGE:"STAGE",PRODUCTION:"PRODUCTION",LOCAL:"LOCAL"},Ui=Xt({...D}),Di=Xt({...ma}),Gi=Xt({...N});var rs="mas-commerce-service";function ns(e,{once:t=!1}={}){let r=null;function n(){let i=document.querySelector(rs);i!==r&&(r=i,i&&e(i))}return document.addEventListener(nt,n,{once:t}),Te(n),()=>document.removeEventListener(nt,n)}function Wt(e,{country:t,forceTaxExclusive:r,perpetual:n}){let i;if(e.length<2)i=e;else{let o=t==="GB"||n?"EN":"MULT",[a,s]=e;i=[a.language===o?a:s]}return r&&(i=i.map(mi)),i}var Te=e=>window.setTimeout(e);function Et(e,t=1){if(e==null)return[t];let r=(Array.isArray(e)?e:String(e).split(",")).map(At).filter(vt);return r.length||(r=[t]),r}function Dr(e){return e==null?[]:(Array.isArray(e)?e:String(e).split(",")).filter(ai)}function q(){return document.getElementsByTagName(rs)?.[0]}var _=Object.freeze({checkoutClientId:"adobe_com",checkoutWorkflow:re.V3,checkoutWorkflowStep:ne.EMAIL,country:"US",displayOldPrice:!0,displayPerUnit:!1,displayRecurrence:!0,displayTax:!1,env:je.PRODUCTION,forceTaxExclusive:!1,language:"en",entitlement:!1,extraOptions:{},modal:!1,promotionCode:"",quantity:1,wcsApiKey:"wcms-commerce-ims-ro-user-milo",wcsBufferDelay:1,wcsURL:"https://www.adobe.com/web_commerce_artifact",landscape:Me.PUBLISHED,wcsBufferLimit:1});var Hi=Object.freeze({LOCAL:"local",PROD:"prod",STAGE:"stage"});function th({locale:e=void 0,country:t=void 0,language:r=void 0}={}){return r??(r=e?.split("_")?.[0]||_.language),t??(t=e?.split("_")?.[1]||_.country),e??(e=`${r}_${t}`),{locale:e,country:t,language:r}}function zi(e={}){let{commerce:t={}}=e,r=je.PRODUCTION,n=Dn,i=O("checkoutClientId",t)??_.checkoutClientId,o=ye(O("checkoutWorkflow",t),re,_.checkoutWorkflow),a=ne.CHECKOUT;o===re.V3&&(a=ye(O("checkoutWorkflowStep",t),ne,_.checkoutWorkflowStep));let s=y(O("displayOldPrice",t),_.displayOldPrice),c=y(O("displayPerUnit",t),_.displayPerUnit),h=y(O("displayRecurrence",t),_.displayRecurrence),l=y(O("displayTax",t),_.displayTax),d=y(O("entitlement",t),_.entitlement),u=y(O("modal",t),_.modal),m=y(O("forceTaxExclusive",t),_.forceTaxExclusive),g=O("promotionCode",t)??_.promotionCode,f=Et(O("quantity",t)),S=O("wcsApiKey",t)??_.wcsApiKey,w=t?.env==="stage",v=Me.PUBLISHED;["true",""].includes(t.allowOverride)&&(w=(O(Mn,t,{metadata:!1})?.toLowerCase()??t?.env)==="stage",v=ye(O(Un,t),Me,v)),w&&(r=je.STAGE,n=Gn);let R=At(O("wcsBufferDelay",t),_.wcsBufferDelay),C=At(O("wcsBufferLimit",t),_.wcsBufferLimit);return{...th(e),displayOldPrice:s,checkoutClientId:i,checkoutWorkflow:o,checkoutWorkflowStep:a,displayPerUnit:c,displayRecurrence:h,displayTax:l,entitlement:d,extraOptions:_.extraOptions,modal:u,env:r,forceTaxExclusive:m,promotionCode:g,quantity:f,wcsApiKey:S,wcsBufferDelay:R,wcsBufferLimit:C,wcsURL:n,landscape:v}}var Fi={DEBUG:"debug",ERROR:"error",INFO:"info",WARN:"warn"},rh=Date.now(),Bi=new Set,ji=new Set,is=new Map,os={append({level:e,message:t,params:r,timestamp:n,source:i}){console[e](`${n}ms [${i}] %c${t}`,"font-weight: bold;",...r)}},as={filter:({level:e})=>e!==Fi.DEBUG},nh={filter:()=>!1};function ih(e,t,r,n,i){return{level:e,message:t,namespace:r,get params(){return n.length===1&&Gt(n[0])&&(n=n[0](),Array.isArray(n)||(n=[n])),n},source:i,timestamp:Date.now()-rh}}function oh(e){[...ji].every(t=>t(e))&&Bi.forEach(t=>t(e))}function ss(e){let t=(is.get(e)??0)+1;is.set(e,t);let r=`${e} #${t}`,n={id:r,namespace:e,module:i=>ss(`${n.namespace}/${i}`),updateConfig:pt};return Object.values(Fi).forEach(i=>{n[i]=(o,...a)=>oh(ih(i,o,e,a,r))}),Object.seal(n)}function Gr(...e){e.forEach(t=>{let{append:r,filter:n}=t;Gt(n)&&ji.add(n),Gt(r)&&Bi.add(r)})}function ah(e={}){let{name:t}=e,r=y(O("commerce.debug",{search:!0,storage:!0}),t===Hi.LOCAL);return Gr(r?os:as),t===Hi.PROD&&Gr(Wn),X}function sh(){Bi.clear(),ji.clear()}var X={...ss($n),Level:Fi,Plugins:{consoleAppender:os,debugFilter:as,quietFilter:nh,lanaAppender:Wn},init:ah,reset:sh,use:Gr};var ch={[he]:Cn,[de]:In,[ue]:kn},lh={[he]:On,[de]:Rn,[ue]:Vn},St=class{constructor(t){p(this,"changes",new Map);p(this,"connected",!1);p(this,"dispose",xt);p(this,"error");p(this,"log");p(this,"options");p(this,"promises",[]);p(this,"state",de);p(this,"timer",null);p(this,"value");p(this,"version",0);p(this,"wrapperElement");this.wrapperElement=t}update(){[he,de,ue].forEach(t=>{this.wrapperElement.classList.toggle(ch[t],t===this.state)})}notify(){(this.state===ue||this.state===he)&&(this.state===ue?this.promises.forEach(({resolve:t})=>t(this.wrapperElement)):this.state===he&&this.promises.forEach(({reject:t})=>t(this.error)),this.promises=[]),this.wrapperElement.dispatchEvent(new CustomEvent(lh[this.state],{bubbles:!0}))}attributeChangedCallback(t,r,n){this.changes.set(t,n),this.requestUpdate()}connectedCallback(){this.dispose=ns(()=>this.requestUpdate(!0))}disconnectedCallback(){this.connected&&(this.connected=!1,this.log?.debug("Disconnected:",{element:this.wrapperElement})),this.dispose(),this.dispose=xt}onceSettled(){let{error:t,promises:r,state:n}=this;return ue===n?Promise.resolve(this.wrapperElement):he===n?Promise.reject(t):new Promise((i,o)=>{r.push({resolve:i,reject:o})})}toggleResolved(t,r,n){return t!==this.version?!1:(n!==void 0&&(this.options=n),this.state=ue,this.value=r,this.update(),this.log?.debug("Resolved:",{element:this.wrapperElement,value:r}),Te(()=>this.notify()),!0)}toggleFailed(t,r,n){return t!==this.version?!1:(n!==void 0&&(this.options=n),this.error=r,this.state=he,this.update(),this.log?.error("Failed:",{element:this.wrapperElement,error:r}),Te(()=>this.notify()),!0)}togglePending(t){return this.version++,t&&(this.options=t),this.state=de,this.update(),Te(()=>this.notify()),this.version}requestUpdate(t=!1){if(!this.wrapperElement.isConnected||!q()||this.timer)return;let r=X.module("mas-element"),{error:n,options:i,state:o,value:a,version:s}=this;this.state=de,this.timer=Te(async()=>{this.timer=null;let c=null;if(this.changes.size&&(c=Object.fromEntries(this.changes.entries()),this.changes.clear()),this.connected?this.log?.debug("Updated:",{element:this.wrapperElement,changes:c}):(this.connected=!0,this.log?.debug("Connected:",{element:this.wrapperElement,changes:c})),c||t)try{await this.wrapperElement.render?.()===!1&&this.state===de&&this.version===s&&(this.state=o,this.error=n,this.value=a,this.update(),this.notify())}catch(h){r.error("Failed to render mas-element: ",h),this.toggleFailed(this.version,h,i)}})}};function cs(e={}){return Object.entries(e).forEach(([t,r])=>{(r==null||r===""||r?.length===0)&&delete e[t]}),e}function Hr(e,t={}){let{tag:r,is:n}=e,i=document.createElement(r,{is:n});return i.setAttribute("is",n),Object.assign(i.dataset,cs(t)),i}function zr(e,t={}){return e instanceof HTMLElement?(Object.assign(e.dataset,cs(t)),e):null}var hh="download",dh="upgrade",Ke,qt=class qt extends HTMLAnchorElement{constructor(){super();M(this,Ke,void 0);p(this,"masElement",new St(this));this.handleClick=this.handleClick.bind(this)}attributeChangedCallback(r,n,i){this.masElement.attributeChangedCallback(r,n,i)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}requestUpdate(r=!1){return this.masElement.requestUpdate(r)}static get observedAttributes(){return["data-checkout-workflow","data-checkout-workflow-step","data-extra-options","data-ims-country","data-perpetual","data-promotion-code","data-quantity","data-template","data-wcs-osi","data-entitlement","data-upgrade","data-modal"]}static createCheckoutLink(r={},n=""){let i=q();if(!i)return null;let{checkoutMarketSegment:o,checkoutWorkflow:a,checkoutWorkflowStep:s,entitlement:c,upgrade:h,modal:l,perpetual:d,promotionCode:u,quantity:m,wcsOsi:g,extraOptions:f}=i.collectCheckoutOptions(r),S=Hr(qt,{checkoutMarketSegment:o,checkoutWorkflow:a,checkoutWorkflowStep:s,entitlement:c,upgrade:h,modal:l,perpetual:d,promotionCode:u,quantity:m,wcsOsi:g,extraOptions:f});return n&&(S.innerHTML=`<span>${n}</span>`),S}get isCheckoutLink(){return!0}handleClick(r){var n;if(r.target!==this){r.preventDefault(),r.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window}));return}(n=L(this,Ke))==null||n.call(this,r)}async render(r={}){if(!this.isConnected)return!1;let n=q();if(!n)return!1;this.dataset.imsCountry||n.imsCountryPromise.then(l=>{l&&(this.dataset.imsCountry=l)},xt),r.imsCountry=null;let i=n.collectCheckoutOptions(r,this);if(!i.wcsOsi.length)return!1;let o;try{o=JSON.parse(i.extraOptions??"{}")}catch(l){this.masElement.log?.error("cannot parse exta checkout options",l)}let a=this.masElement.togglePending(i);this.href="";let s=n.resolveOfferSelectors(i),c=await Promise.all(s);c=c.map(l=>Wt(l,i)),i.country=this.dataset.imsCountry||i.country;let h=await n.buildCheckoutAction?.(c.flat(),{...o,...i},this);return this.renderOffers(c.flat(),i,{},h,a)}renderOffers(r,n,i={},o=void 0,a=void 0){if(!this.isConnected)return!1;let s=q();if(!s)return!1;if(n={...JSON.parse(this.dataset.extraOptions??"null"),...n,...i},a??(a=this.masElement.togglePending(n)),L(this,Ke)&&B(this,Ke,void 0),o){this.classList.remove(hh,dh),this.masElement.toggleResolved(a,r,n);let{url:h,text:l,className:d,handler:u}=o;return h&&(this.href=h),l&&(this.firstElementChild.innerHTML=l),d&&this.classList.add(...d.split(" ")),u&&(this.setAttribute("href","#"),B(this,Ke,u.bind(this))),!0}else if(r.length){if(this.masElement.toggleResolved(a,r,n)){let h=s.buildCheckoutURL(r,n);return this.setAttribute("href",h),!0}}else{let h=new Error(`Not provided: ${n?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(a,h,n))return this.setAttribute("href","#"),!0}}updateOptions(r={}){let n=q();if(!n)return!1;let{checkoutMarketSegment:i,checkoutWorkflow:o,checkoutWorkflowStep:a,entitlement:s,upgrade:c,modal:h,perpetual:l,promotionCode:d,quantity:u,wcsOsi:m}=n.collectCheckoutOptions(r);return zr(this,{checkoutMarketSegment:i,checkoutWorkflow:o,checkoutWorkflowStep:a,entitlement:s,upgrade:c,modal:h,perpetual:l,promotionCode:d,quantity:u,wcsOsi:m}),!0}};Ke=new WeakMap,p(qt,"is","checkout-link"),p(qt,"tag","a");var ie=qt;window.customElements.get(ie.is)||window.customElements.define(ie.is,ie,{extends:ie.tag});function ls({providers:e,settings:t}){function r(o,a){let{checkoutClientId:s,checkoutWorkflow:c,checkoutWorkflowStep:h,country:l,language:d,promotionCode:u,quantity:m}=t,{checkoutMarketSegment:g,checkoutWorkflow:f=c,checkoutWorkflowStep:S=h,imsCountry:w,country:v=w??l,language:A=d,quantity:R=m,entitlement:C,upgrade:$,modal:F,perpetual:ae,promotionCode:Ye=u,wcsOsi:Le,extraOptions:Xe,...J}=Object.assign({},a?.dataset??{},o??{}),fe=ye(f,re,_.checkoutWorkflow),se=ne.CHECKOUT;fe===re.V3&&(se=ye(S,ne,_.checkoutWorkflowStep));let Q=bt({...J,extraOptions:Xe,checkoutClientId:s,checkoutMarketSegment:g,country:v,quantity:Et(R,_.quantity),checkoutWorkflow:fe,checkoutWorkflowStep:se,language:A,entitlement:y(C),upgrade:y($),modal:y(F),perpetual:y(ae),promotionCode:Ht(Ye).effectivePromoCode,wcsOsi:Dr(Le)});if(a)for(let _e of e.checkout)_e(a,Q);return Q}function n(o,a){if(!Array.isArray(o)||!o.length||!a)return"";let{env:s,landscape:c}=t,{checkoutClientId:h,checkoutMarketSegment:l,checkoutWorkflow:d,checkoutWorkflowStep:u,country:m,promotionCode:g,quantity:f,...S}=r(a),w=window.frameElement?"if":"fp",v={checkoutPromoCode:g,clientId:h,context:w,country:m,env:s,items:[],marketSegment:l,workflowStep:u,landscape:c,...S};if(o.length===1){let[{offerId:A,offerType:R,productArrangementCode:C}]=o,{marketSegments:[$]}=o[0];Object.assign(v,{marketSegment:$,offerType:R,productArrangementCode:C}),v.items.push(f[0]===1?{id:A}:{id:A,quantity:f[0]})}else v.items.push(...o.map(({offerId:A},R)=>({id:A,quantity:f[R]??_.quantity})));return ei(d,v)}let{createCheckoutLink:i}=ie;return{CheckoutLink:ie,CheckoutWorkflow:re,CheckoutWorkflowStep:ne,buildCheckoutURL:n,collectCheckoutOptions:r,createCheckoutLink:i}}function uh({interval:e=200,maxAttempts:t=25}={}){let r=X.module("ims");return new Promise(n=>{r.debug("Waing for IMS to be ready");let i=0;function o(){window.adobeIMS?.initialized?n():++i>t?(r.debug("Timeout"),n()):setTimeout(o,e)}o()})}function mh(e){return e.then(()=>window.adobeIMS?.isSignedInUser()??!1)}function ph(e){let t=X.module("ims");return e.then(r=>r?window.adobeIMS.getProfile().then(({countryCode:n})=>(t.debug("Got user country:",n),n),n=>{t.error("Unable to get user country:",n)}):null)}function hs({}){let e=uh(),t=mh(e),r=ph(t);return{imsReadyPromise:e,imsSignedInPromise:t,imsCountryPromise:r}}async function us(e,t){let{data:r}=t||await Promise.resolve().then(()=>ks(ds(),1));if(Array.isArray(r)){let n=o=>r.find(a=>Lr(a.lang,o)),i=n(e.language)??n(_.language);if(i)return Object.freeze(i)}return{}}var ms=["GB_en","AU_en","FR_fr","AT_de","BE_en","BE_fr","BE_nl","BG_bg","CH_de","CH_fr","CH_it","CZ_cs","DE_de","DK_da","EE_et","EG_ar","EG_en","ES_es","FI_fi","FR_fr","GR_el","GR_en","HU_hu","IE_en","IT_it","LU_de","LU_en","LU_fr","NL_nl","NO_nb","PL_pl","PT_pt","RO_ro","SE_sv","SI_sl","SK_sk","TR_tr","UA_uk","ID_en","ID_in","IN_en","IN_hi","JP_ja","MY_en","MY_ms","NZ_en","TH_en","TH_th"],gh={INDIVIDUAL_COM:["ZA_en","LT_lt","LV_lv","NG_en","SA_ar","SA_en","ZA_en","SG_en","KR_ko"],TEAM_COM:["ZA_en","LT_lt","LV_lv","NG_en","ZA_en","CO_es","KR_ko"],INDIVIDUAL_EDU:["LT_lt","LV_lv","SA_en","SG_en"],TEAM_EDU:["SG_en","KR_ko"]},Zt=class Zt extends HTMLSpanElement{constructor(){super();p(this,"masElement",new St(this));this.handleClick=this.handleClick.bind(this)}static get observedAttributes(){return["data-display-old-price","data-display-per-unit","data-display-recurrence","data-display-tax","data-perpetual","data-promotion-code","data-tax-exclusive","data-template","data-wcs-osi"]}static createInlinePrice(r){let n=q();if(!n)return null;let{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:h,promotionCode:l,quantity:d,template:u,wcsOsi:m}=n.collectPriceOptions(r);return Hr(Zt,{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:h,promotionCode:l,quantity:d,template:u,wcsOsi:m})}get isInlinePrice(){return!0}attributeChangedCallback(r,n,i){this.masElement.attributeChangedCallback(r,n,i)}connectedCallback(){this.masElement.connectedCallback(),this.addEventListener("click",this.handleClick)}disconnectedCallback(){this.masElement.disconnectedCallback(),this.removeEventListener("click",this.handleClick)}handleClick(r){r.target!==this&&(r.stopImmediatePropagation(),this.dispatchEvent(new MouseEvent("click",{bubbles:!0,cancelable:!0,view:window})))}onceSettled(){return this.masElement.onceSettled()}get value(){return this.masElement.value}get options(){return this.masElement.options}requestUpdate(r=!1){return this.masElement.requestUpdate(r)}resolveDisplayTaxForGeoAndSegment(r,n,i,o){let a=`${r}_${n}`;if(ms.includes(r)||ms.includes(a))return!0;let s=gh[`${i}_${o}`];return s?!!(s.includes(r)||s.includes(a)):!1}async resolveDisplayTax(r,n){let[i]=await r.resolveOfferSelectors(n),o=Wt(await i,n);if(o?.length){let{country:a,language:s}=n,c=o[0],[h=""]=c.marketSegments;return this.resolveDisplayTaxForGeoAndSegment(a,s,c.customerSegment,h)}}async render(r={}){if(!this.isConnected)return!1;let n=q();if(!n)return!1;let i=n.collectPriceOptions(r,this);if(!i.wcsOsi.length)return!1;let o=this.masElement.togglePending(i);this.innerHTML="";let[a]=n.resolveOfferSelectors(i);return this.renderOffers(Wt(await a,i),i,o)}renderOffers(r,n={},i=void 0){if(!this.isConnected)return;let o=q();if(!o)return!1;let a=o.collectPriceOptions({...this.dataset,...n},this);if(i??(i=this.masElement.togglePending(a)),r.length){if(this.masElement.toggleResolved(i,r,a))return this.innerHTML=o.buildPriceHTML(r,a),!0}else{let s=new Error(`Not provided: ${a?.wcsOsi??"-"}`);if(this.masElement.toggleFailed(i,s,a))return this.innerHTML="",!0}return!1}updateOptions(r){let n=q();if(!n)return!1;let{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:h,promotionCode:l,quantity:d,template:u,wcsOsi:m}=n.collectPriceOptions(r);return zr(this,{displayOldPrice:i,displayPerUnit:o,displayRecurrence:a,displayTax:s,forceTaxExclusive:c,perpetual:h,promotionCode:l,quantity:d,template:u,wcsOsi:m}),!0}};p(Zt,"is","inline-price"),p(Zt,"tag","span");var oe=Zt;window.customElements.get(oe.is)||window.customElements.define(oe.is,oe,{extends:oe.tag});function ps({literals:e,providers:t,settings:r}){function n(a,s){let{country:c,displayOldPrice:h,displayPerUnit:l,displayRecurrence:d,displayTax:u,forceTaxExclusive:m,language:g,promotionCode:f,quantity:S}=r,{displayOldPrice:w=h,displayPerUnit:v=l,displayRecurrence:A=d,displayTax:R=u,forceTaxExclusive:C=m,country:$=c,language:F=g,perpetual:ae,promotionCode:Ye=f,quantity:Le=S,template:Xe,wcsOsi:J,...fe}=Object.assign({},s?.dataset??{},a??{}),se=bt({...fe,country:$,displayOldPrice:y(w),displayPerUnit:y(v),displayRecurrence:y(A),displayTax:y(R),forceTaxExclusive:y(C),language:F,perpetual:y(ae),promotionCode:Ht(Ye).effectivePromoCode,quantity:Et(Le,_.quantity),template:Xe,wcsOsi:Dr(J)});if(s)for(let Q of t.price)Q(s,se);return se}function i(a,s){if(!Array.isArray(a)||!a.length||!s)return"";let{template:c}=s,h;switch(c){case"discount":h=Mi;break;case"strikethrough":h=Oi;break;case"optical":h=Ni;break;case"annual":h=Ri;break;default:s.country==="AU"&&a[0].planType==="ABM"?h=s.promotionCode?$i:Vi:h=s.promotionCode?ki:Ii}let l=n(s);l.literals=Object.assign({},e.price,bt(s.literals??{}));let[d]=a;return d={...d,...d.priceDetails},h(l,d)}let o=oe.createInlinePrice;return{InlinePrice:oe,buildPriceHTML:i,collectPriceOptions:n,createInlinePrice:o}}function fs({settings:e}){let t=X.module("wcs"),{env:r,wcsApiKey:n}=e,i=new Map,o=new Map,a;async function s(d,u,m=!0){let g=Nn;t.debug("Fetching:",d);let f="",S,w=(v,A,R)=>`${v}: ${A?.status}, url: ${R.toString()}`;try{if(d.offerSelectorIds=d.offerSelectorIds.sort(),f=new URL(e.wcsURL),f.searchParams.set("offer_selector_ids",d.offerSelectorIds.join(",")),f.searchParams.set("country",d.country),f.searchParams.set("locale",d.locale),f.searchParams.set("landscape",r===je.STAGE?"ALL":e.landscape),f.searchParams.set("api_key",n),d.language&&f.searchParams.set("language",d.language),d.promotionCode&&f.searchParams.set("promotion_code",d.promotionCode),d.currency&&f.searchParams.set("currency",d.currency),S=await fetch(f.toString(),{credentials:"omit"}),S.ok){let v=await S.json();t.debug("Fetched:",d,v);let A=v.resolvedOffers??[];A=A.map(Pr),u.forEach(({resolve:R},C)=>{let $=A.filter(({offerSelectorIds:F})=>F.includes(C)).flat();$.length&&(u.delete(C),R($))})}else S.status===404&&d.offerSelectorIds.length>1?(t.debug("Multi-osi 404, fallback to fetch-by-one strategy"),await Promise.allSettled(d.offerSelectorIds.map(v=>s({...d,offerSelectorIds:[v]},u,!1)))):g=gr}catch(v){g=gr,t.error(g,d,v)}m&&u.size&&(t.debug("Missing:",{offerSelectorIds:[...u.keys()]}),u.forEach(v=>{v.reject(new Error(w(g,S,f)))}))}function c(){clearTimeout(a);let d=[...o.values()];o.clear(),d.forEach(({options:u,promises:m})=>s(u,m))}function h(){let d=i.size;i.clear(),t.debug(`Flushed ${d} cache entries`)}function l({country:d,language:u,perpetual:m=!1,promotionCode:g="",wcsOsi:f=[]}){let S=`${u}_${d}`;d!=="GB"&&(u=m?"EN":"MULT");let w=[d,u,g].filter(v=>v).join("-").toLowerCase();return f.map(v=>{let A=`${v}-${w}`;if(!i.has(A)){let R=new Promise((C,$)=>{let F=o.get(w);if(!F){let ae={country:d,locale:S,offerSelectorIds:[]};d!=="GB"&&(ae.language=u),F={options:ae,promises:new Map},o.set(w,F)}g&&(F.options.promotionCode=g),F.options.offerSelectorIds.push(v),F.promises.set(v,{resolve:C,reject:$}),F.options.offerSelectorIds.length>=e.wcsBufferLimit?c():(t.debug("Queued:",F.options),a||(a=setTimeout(c,e.wcsBufferDelay)))});i.set(A,R)}return i.get(A)})}return{WcsCommitment:Ui,WcsPlanType:Di,WcsTerm:Gi,resolveOfferSelectors:l,flushWcsCache:h}}var Ki="mas-commerce-service",Br,gs,Fr=class extends HTMLElement{constructor(){super(...arguments);M(this,Br);p(this,"promise",null)}async registerCheckoutAction(r){typeof r=="function"&&(this.buildCheckoutAction=async(n,i,o)=>{let a=await r?.(n,i,this.imsSignedInPromise,o);return a||null})}async activate(){let r=L(this,Br,gs),n=Object.freeze(zi(r));pt(r.lana);let i=X.init(r.hostEnv).module("service");i.debug("Activating:",r);let o={price:{}};try{o.price=await us(n,r.commerce.priceLiterals)}catch{}let a={checkout:new Set,price:new Set},s={literals:o,providers:a,settings:n};Object.defineProperties(this,Object.getOwnPropertyDescriptors({...ls(s),...hs(s),...ps(s),...fs(s),...Hn,Log:X,get defaults(){return _},get log(){return X},get providers(){return{checkout(c){return a.checkout.add(c),()=>a.checkout.delete(c)},price(c){return a.price.add(c),()=>a.price.delete(c)}}},get settings(){return n}})),i.debug("Activated:",{literals:o,settings:n}),Te(()=>{let c=new CustomEvent(nt,{bubbles:!0,cancelable:!1,detail:this});this.dispatchEvent(c)})}connectedCallback(){this.readyPromise||(this.readyPromise=this.activate())}disconnectedCallback(){this.readyPromise=null}flushWcsCache(){this.flushWcsCache(),this.log.debug("Flushed WCS cache")}refreshOffers(){this.flushWcsCache(),document.querySelectorAll('span[is="inline-price"],a[is="checkout-link"]').forEach(r=>r.requestUpdate(!0)),this.log.debug("Refreshed WCS offers")}refreshFragments(){this.flushWcsCache(),document.querySelectorAll("aem-fragment").forEach(r=>r.refresh()),this.log.debug("Refreshed AEM fragments")}};Br=new WeakSet,gs=function(){let r={hostEnv:{name:this.getAttribute("host-env")??"prod"},commerce:{env:this.getAttribute("env")},lana:{tags:this.getAttribute("lana-tags"),sampleRate:parseInt(this.getAttribute("lana-sample-rate"),10),isProdDomain:this.getAttribute("host-env")==="prod"}};return["locale","country","language"].forEach(n=>{let i=this.getAttribute(n);i&&(r[n]=i)}),["checkout-workflow-step","force-tax-exclusive","checkout-client-id","allow-override","wcs-api-key"].forEach(n=>{let i=this.getAttribute(n);if(i!=null){let o=n.replace(/-([a-z])/g,a=>a[1].toUpperCase());r.commerce[o]=i}}),r},p(Fr,"instance");window.customElements.get(Ki)||window.customElements.define(Ki,Fr);pt({sampleRate:1});export{ie as CheckoutLink,re as CheckoutWorkflow,ne as CheckoutWorkflowStep,_ as Defaults,oe as InlinePrice,Me as Landscape,X as Log,Ki as TAG_NAME_SERVICE,Ui as WcsCommitment,Di as WcsPlanType,Gi as WcsTerm,Pr as applyPlanType,zi as getSettings};
